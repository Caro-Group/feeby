...
<article class="h-full bg-gray-1000 flex flex-col">
	...
	<div class="flex flex-col px-[30px] flex-auto">
		...
		{if $config->get('listing_show_readmore',1)}
			<a class="mt-auto mb-[35px] flex items-center uppercase text-[14px] mr-[16px] leading-[16px] text-main-dark" href="{$blog.link|escape:'html':'UTF-8'}" title="{$blog.title|escape:'html':'UTF-8'}">

...
<div id="filter-options_{$filter.id_filter|intval}" class="overflow-hidden collapse in"
    aria-expanded="true" >
  <ul class="filter-options_container flex flex-wrap pb-[30px] {if $filter.id_filter == 23} gap-x-[30px] gap-y-5 items-end {else}{if $filter.id_filter == 50 || $filter.id_filter == 64}gap-y-5{else}gap-2.5{/if} {/if}">
        {foreach $filter.options item=option}
            {if $option}
            <li class="max-w-full {if $filter.id_filter == 50 || $filter.id_filter == 64 || $filter.id_filter == 92}w-full phone:w-1/2 phone:px-2 tablet:px-0 tablet:w-auto desktop:mr-10{/if}">
                    <label for="option_{$option.id_option|intval}" class=" !flex {if $filter.id_filter == 50 || $filter.id_filter == 64 || $filter.id_filter == 92} option-svg flex-col {else} border-2 border-solid border-gray-2000 hover:border-gray-3000 !p-[9px] tablet:!p-[13px] {/if} items-center w-full cursor-pointer !mb-0 {if $option.selected } active {/if} rounded-[5px] transition duration-200 ">
                        <input
                        ...
                        <div class="shrink-0 bg-gray-2000 clearfix float-left w-[25px] h-[25px] mr-2.5 rounded-full border border-solid" style="
                          ...
                          {elseif $option.id_option == 1125 || $option.id_option == 1961} {* Multicolor *}
                            ...
                            border-color: #ADAFBA;
                          {elseif $option.id_option == 1126 || $option.id_option == 1956} {* Blue *}
                            background-color: #005FB1;
                            border-color: #005FB1;
                          {elseif $option.id_option == 1127 || $option.id_option == 1962} {* Orange *}
                          ...
                          {elseif $option.id_option == 1130 || $option.id_option == 1959} {* Grey *}
                            ...
                            border-color: #848484;
                          {elseif $option.id_option == 1132 || $option.id_option == 1960} {* Green *}
                          ...
                          {elseif $option.id_option == 1119 || $option.id_option == 1968} {* White *}
                            ...
                            border-color: #ADAFBA;
                          {elseif $option.id_option == 1131 || $option.id_option == 1966} {* Turquoise *}
                            background-color: #40E0D0;
                            border-color: #40E0D0;
                          {elseif $option.id_option == 11 }
                            background: #FFFFFF;
                            border-color: #ADAFBA;
                          {elseif $option.id_option == 1122 || $option.id_option == 1954}  {* Black *}
                        ...
                        {if $filter.id_filter == 50 || $filter.id_filter == 64 || $filter.id_filter == 92}
                          <div class="shrink-0">


                          {if $option.id_option == 1137 || $option.id_option == 1291 || $option.id_option == 1986} {* PION *}
                          ...
                          {elseif $option.id_option == 1135 || $option.id_option == 1292 || $option.id_option == 1979} {* POZIOM *}
                          ...
                          {elseif $option.id_option == 1136 || $option.id_option == 1288 || $option.id_option == 1984} {* KWADRAT *}
                          ...
                          {elseif $option.id_option == 1217 || $option.id_option == 1293 || $option.id_option == 1985} {* TRYPTYK *}
                          ...
                          {elseif $option.id_option == 1218 || $option.id_option == 1287 || $option.id_option == 1978} {* 5 CZESCI *}
                          ...
                          {elseif $option.id_option == 1221 || $option.id_option == 1294 || $option.id_option == 1981} {* PANORAMA POZIOM *}
                          ...
                          {elseif $option.id_option == 1220 || $option.id_option == 1289 || $option.id_option == 1982} {* PANORAMA PION *}
                          ...
                          {elseif $option.id_option == 1219 || $option.id_option == 1290 || $option.id_option == 1983} {* ZESTAW *}
...
{*
                        ...
                        {if $filter.type eq 5 and $option.color and ($option.color.color or $option.color.texture)}
                            ...
                            {/if}
                        {else}
                        <span class="{if $filter.id_filter == 50 || $filter.id_filter == 64 || $filter.id_filter == 92}text-center{/if} text-base block text-main-dark w-auto {if $filter.id_filter == 50 || $filter.id_filter == 23 && ($option.id_option == 969 || $option.id_option == 970) || ($filter.id_filter == 92 && ($option.id_option == 1981 || $option.id_option == 1982) )} max-w-[72px] text-center tablet:mt-1 {else} max-w-full {/if} font-body font-normal">{$option.name|escape:'htmlall':'UTF-8'}</span>
                        {/if}

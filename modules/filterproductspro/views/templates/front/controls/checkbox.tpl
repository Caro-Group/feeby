...
<div id="filter-options_{$filter.id_filter|intval}" class="overflow-hidden collapse in"
    aria-expanded="true" >
  <ul class="filter-options_container flex flex-wrap pb-[30px] {if $filter.id_filter == 23} gap-x-[30px] gap-y-5 items-end {else}{if $filter.id_filter == 50 || $filter.id_filter == 92}gap-y-5{else}gap-2.5{/if} {/if}">
        {foreach $filter.options item=option}
            {if $option}
            <li class="max-w-full {if $filter.id_filter == 50 || $filter.id_filter == 92}w-full phone:w-1/2 phone:px-2 tablet:px-0 tablet:w-auto desktop:mr-10{/if}">
                    <label for="option_{$option.id_option|intval}" class=" !flex {if $filter.id_filter == 50 || $filter.id_filter == 92} option-svg flex-col {else} border-2 border-solid border-gray-2000 hover:border-gray-3000 !p-[9px] tablet:!p-[13px] {/if} items-center w-full cursor-pointer !mb-0 {if $option.selected } active {/if} rounded-[5px] transition duration-200 ">
                        <input
                        ...
                        <div class="shrink-0 bg-gray-2000 clearfix float-left w-[25px] h-[25px] mr-2.5 rounded-full border border-solid" style="
                          {if $option.id_option == 1118 || $option.id_option == 1953}
                            background-color: #FEF3DE;
                            border-color: #FEF3DE;
                          {elseif $option.id_option == 1120 || $option.id_option == 1955}
                            background-color: #AA6D12;
                            border-color: #AA6D12;
                          {elseif $option.id_option == 1121 || $option.id_option == 1956}
                            background: linear-gradient(270deg, #000000 50.51%, #FFFFFF 50.52%);
                            border-color: #ADAFBA;
                          {elseif $option.id_option == 1123 || $option.id_option == 1958}
                            background-color: #ED0000;
                            border-color: #ED0000;
                          {elseif $option.id_option == 1124 || $option.id_option == 1959}
                            background-color: #C23D85;
                            border-color: #C23D85;
                          {elseif $option.id_option == 1125 || $option.id_option == 1960}
                            background: linear-gradient( 90deg, rgba(255, 0, 0, 1) 0%, rgba(255, 154, 0, 1) 10%, rgba(208, 222, 33, 1) 20%, rgba(79, 220, 74, 1) 30%, rgba(63, 218, 216, 1) 40%, rgba(47, 201, 226, 1) 50%, rgba(28, 127, 238, 1) 60%, rgba(95, 21, 242, 1) 70%, rgba(186, 12, 248, 1) 80%, rgba(251, 7, 217, 1) 90%, rgba(255, 0, 0, 1) 100% );
                            border-color: #ADAFBA;
                          {elseif $option.id_option == 1126 || $option.id_option == 1961}
                            background-color: #005FB1;
                            border-color: #005FB1;
                          {elseif $option.id_option == 1127 || $option.id_option == 1962}
                            background-color: #FF9A02;
                            border-color: #FF9A02;
                          {elseif $option.id_option == 1128 || $option.id_option == 1963}
                            background-color: #FFB6C1;
                            border-color: #FFB6C1;
                          {elseif $option.id_option == 1129 || $option.id_option == 1964}
                            background-color: #EAEAEA;
                            border-color: #EAEAEA;
                          {elseif $option.id_option == 1130 || $option.id_option == 1965}
                            background-color: #848484;
                            border-color: #848484;
                          {elseif $option.id_option == 1132 || $option.id_option == 1967}
                            background-color: #46932A;
                            border-color: #46932A;
                          {elseif $option.id_option == 1134 || $option.id_option == 1969}
                            background-color: #DFCA80;
                            border-color: #DFCA80;
                          {elseif $option.id_option == 1133 || $option.id_option == 1970}
                            background-color: #FFE233;
                            border-color: #FFE233;
                          {elseif $option.id_option == 1119 || $option.id_option == 1954}
                            background-color: #FFFFFF;
                            border-color: #ADAFBA;
                          {elseif $option.id_option == 1131 || $option.id_option == 1966}
                            background-color: #40E0D0;
                            border-color: #40E0D0;
                          {elseif $option.id_option == 11} 
                            background: #FFFFFF;
                            border-color: #ADAFBA;
                          {elseif $option.id_option == 1122 || $option.id_option == 1957}
                        ...
                        {if $filter.id_filter == 50 || $filter.id_filter == 92}
                          <div class="shrink-0">


                          {if $option.id_option == 1137 || $option.id_option == 1986} {* PION *}
                          ...
                          {elseif $option.id_option == 1135 || $option.id_option == 1979} {* POZIOM *}
                          ...
                          {elseif $option.id_option == 1136 || $option.id_option == 1984} {* KWADRAT *}
                          ...
                          {elseif $option.id_option == 1217 || $option.id_option == 1985} {* TRYPTYK *}
                          ...
                          {elseif $option.id_option == 1218 || $option.id_option == 1978} {* 5 CZESCI *}
                          ...
                          {elseif $option.id_option == 1221 || $option.id_option == 1981} {* PANORAMA POZIOM *}
                          ...
                          {elseif $option.id_option == 1220 || $option.id_option == 1982} {* PANORAMA PION *}
                          ...
                          {elseif $option.id_option == 1219 || $option.id_option == 1983} {* ZESTAW *}
...
{*
                        ...
                        {if $filter.type eq 5 and $option.color and ($option.color.color or $option.color.texture)}
                            ...
                            {/if}
                        {else}
                        <span class="{if $filter.id_filter == 50 || $filter.id_filter == 92}text-center{/if} text-base block text-main-dark w-auto {(if $filter.id_filter == 50 && ($option.id_option == 969 || $option.id_option == 970)) || ($filter.id_filter == 92 && ($option.id_option == 1981 || $option.id_option == 1982) )} max-w-[72px] text-center tablet:mt-1 {else} max-w-full {/if} font-body font-normal">{$option.name|escape:'htmlall':'UTF-8'}</span>
                        {/if}

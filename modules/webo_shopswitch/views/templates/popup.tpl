...
<div id="shopswitch-popup"
    ...
    <div
        ...
        <form name="lang-curr-form" class="w-full flex flex-col items-center ">
                        ...
                        <li class="basis-1/3">
                            ...
                            <label for="{$shop.id_shop}"
                                ...
                                <span class="text-base font-normal text-main-dark">{$shop.lang.name} |
                                    {Db::getInstance()->getValue(Currency::getIdByQuery($shop.id_shop))}</span>
                            </label>
                        </li>
                    {/foreach}
                </ul>
            ...
            <button type="button"
                class="bg-main-dark hover:bg-main-hover duration-150 border-0 rounded-full text-white px-4 py-3 text-sm uppercase whitespace-nowrap font-body cursor-pointer">

...
{if isset($links)}
	...
	{/if}
	<div class="widget-inner {if isset($widget_heading)&&!empty($widget_heading)} dropdown-widget-inner tablet-medium:!visible tablet-medium:!opacity-100 tablet-medium:!translate-y-0 {/if}">	

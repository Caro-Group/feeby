...
<div class="translatable-field row lang-{$language.id_lang|escape:'quotes':'UTF-8'}">
	<div class="col-lg-9">
{/if}
		<textarea id="{$input_name|escape:'quotes':'UTF-8'}_{$language.id_lang|escape:'quotes':'UTF-8'}" name="{$input_name|escape:'quotes':'UTF-8'}_{$language.id_lang|escape:'quotes':'UTF-8'}" class="{if isset($class)}{$class|escape:'quotes':'UTF-8'}{else}textarea-autosize{/if}">{if isset($input_value[$language.id_lang])}{$input_value[$language.id_lang]|htmlentitiesUTF8}{/if}</textarea>

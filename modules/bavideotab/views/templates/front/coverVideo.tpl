{if !empty($infor)}
    <div onclick="popupvideo()" class="absolute bg-white border border-gray-1000 border-solid bottom-0 bottom-3 flex items-center leading-3 p-2 right-3 rounded-[5px] text-[12px]">

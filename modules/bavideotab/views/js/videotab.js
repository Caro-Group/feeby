...
function Edit(id_product) {
  ...
  $.post(
    '' + url + '?fc=module&module=bavideotab&controller=editvideo',
    {
      id: id_product,
    },
...
function ConfirmDelete(id_product, type, id_lang) {
  ...
  if (x == true) {
    $.post(
      url + '?fc=module&module=bavideotab&controller=confirmdelete',
      {
        id: id_product,
        id_lang: id_lang,
        id_shop: id_shop_new,
...
function hideOtherLanguage1(id) {
  ...
  if (id_old_language != id) changeEmployeeLanguage()

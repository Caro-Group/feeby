...
<div id="lddw-cookie-modal-box" class="bg-gray-1000 bottom-0 fixed left-0 p-2 rounded text-center w-[300px] m-[10px] border border-solid z-30">
    <span class="absolute font-body leading-none pointer px-2 py-1 right-0 text-[#6B7280] text-[14px] top-0">✕</span>
    ...
    <p class="flex justify-between">
        <button class="bg-primary border-none font-body font-normal p-2 px-[30px] rounded-[23px] text-white uppercase"

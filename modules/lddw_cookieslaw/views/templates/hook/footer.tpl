...
*}
{if !$cookie_setted}
<div id="lddw-cookie-modal-box" class="hidden bg-gray-1000 bottom-0 fixed right-0 trusted-breakpoint:right-auto p-2 rounded text-center w-[300px] m-[10px] border border-solid z-30">

...
<script type="text/javascript">
    document.addEventListener("DOMContentLoaded", function() {
        var wrapper = document.getElementById('left-column');
        var sticker = document.createElement('div');
        sticker.id="ts_review_sticker";
        sticker.className="float-left";
        wrapper.parentNode.appendChild(sticker);
        document.getElementById('content-wrapper').className += " float-right";

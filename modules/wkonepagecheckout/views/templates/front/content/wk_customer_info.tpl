    ...
    {else}
        ...
        <div class="wk-form-group">
            ...
            <div class="form-group wkpassword_div {if Configuration::get('WK_CHECKOUT_GUEST_ALLOW')}wkhide{/if}">
                <input maxlength="60" type="password" name="wk-password" id="wk-password" placeholder="{l s='Password' mod='wkonepagecheckout'}" class="form-control border-gray-2000 border-solid border rounded-full bg-white">

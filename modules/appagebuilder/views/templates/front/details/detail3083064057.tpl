...
<section id="main" class="product-detail detail-3083064057 product-image-thumbs product-thumbs-bottom" itemscope itemtype="https://schema.org/Product">
...
<div class="product-actions">
  {block name='product_buy'}
    <form action="{$urls.pages.cart}" method="post" id="add-to-cart-or-refresh">
     ...
     <div style="border: 1px solid #ccc;border-width: 1px 0;">

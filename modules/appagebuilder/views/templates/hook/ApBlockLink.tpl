                ...
                {if isset($formAtts.links) && $formAtts.links|@count > 0}
                    <ul class="flex items-center">
                        ...
                        <li class="ml-6 leading-[16px] hidden tablet-medium:block">
                            <a class="text-main-dark hover:text-main transition font-body flex items-center gap-1 {if $logged} leo-quicklogin{/if}"
                                    {if $logged}
                                        href="{$my_account_url}"
                                    ...
                                    {/if}>
                                <span
                                    class="shrink-0 w-[18px] h-[18px] rounded-full border border-solid border-current overflow-hidden">
                                    <svg class="fill-current" xmlns="http://www.w3.org/2000/svg" width="16"
                                        height="16" viewBox="1 -2 22 22" fill="none">
                                        <path
                                ...
                                </span>{if $logged}{l s='My account' d='Shop.Theme.Customeraccount'}{else}{l s='Login / Register' d='Shop.Theme.Customeraccount'}{/if}
                            </a>
                        </li>
                    </ul>
                {/if}

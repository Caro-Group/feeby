    ...
    {if (isset($formAtts.image) && $formAtts.image) || (isset($formAtts.image_link) && $formAtts.image_link)}
        {if isset($formAtts.url) && $formAtts.url}
            ...
            <img {if $aplazyload}loading="lazy"{/if} class="rounded-[5px] h-auto" {($formAtts.form_id|escape:'html':'UTF-8' == "form_18561261627433088") ? '' : 'data-pagespeed-no-transform'}
                ...
                width="{((isset($formAtts.width) && $formAtts.width) ? ($formAtts.width|replace:"px":"") : 'auto')|escape:'html':'UTF-8'}"
                height="{((isset($formAtts.height) && $formAtts.height) ? ($formAtts.height|replace:"px":"") : 'auto')|escape:'html':'UTF-8'}"
                />

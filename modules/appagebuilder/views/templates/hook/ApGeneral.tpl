...
{* phone-wide:px-4 phone wide:justify-center  phablet:mx-5 desktop:mx-16 mx-0 h-1/2 h-5 tablet:h-10 select-none font-light desktop:justify-center h-6 text-xs tablet:text-sm tablet:text-base phone-wide:mr-0 h-4 tablet:h-1/2 w-max -mx-8 phone:-mx-0*}

...
{* phone-wide:px-4 phone wide:justify-center  phablet:mx-5 desktop:mx-16 mx-0 h-1/2 h-5 tablet:h-10 select-none font-light desktop:justify-center h-6 text-xs*}

                        ...
                        <div class="left-block">
                            <div class="block-carousel-image-container image">
                                ...
                                {if isset($slider.title) && !empty($slider.title)}
                                        <div class="title text-main-dark font-semibold mb-6 text-base font-header">{$slider.title|escape:'html':'UTF-8' nofilter}</div>
                                {/if}
							...
							{/if}
                                {if isset($slider.descript) && !empty($slider.descript)}
                                        <div class="descript text-main-dark">{$slider.descript|rtrim nofilter}{* HTML form , no escape necessary *}</div>
                                {/if}

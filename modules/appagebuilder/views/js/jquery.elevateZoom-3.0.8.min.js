...
;(function (d, h, l, m) {
  var k = {
    ...
    startZoom: function () {
      ...
      b.options.showLens &&
        (b.zoomLens.on('touchmove', function (a) {
          a.preventDefault()
          b.setPosition(
            a.originalEvent.touches[0] || a.originalEvent.changedTouches[0],
          )
      ...
      'inner' != b.options.zoomType &&
        b.zoomLens.on('mousemove', function (a) {
          if (b.lastX !== a.clientX || b.lastY !== a.clientY)
            b.setPosition(a), (b.currentLoc = a)
          b.lastX = a.clientX
          b.lastY = a.clientY
      ...
      b.options.tint &&
        'inner' != b.options.zoomType &&
        b.zoomTint.on('mousemove', function (a) {
          if (b.lastX !== a.clientX || b.lastY !== a.clientY)
            b.setPosition(a), (b.currentLoc = a)
          b.lastX = a.clientX
          b.lastY = a.clientY
      ...
      b.options.scrollZoom &&
        b.zoomContainer
          .add(b.$elem)
          .on(leo + 'DOMMouseScroll MozMousePixelScroll', function (a) {
            b.scrollLock = !0

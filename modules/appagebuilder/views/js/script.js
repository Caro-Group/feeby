          ...
          success: function (jsonData) {
            if (jsonData) {
              ...
              if (jsonData.product_one_img) {
                ...
                $('.product-additional').each(function () {
                  if (listProductImg[$(this).data('idproduct')]) {
                    ...
                    $(this).html(
                      '<img class="img-fluid" loading="lazy" title="' +
                        name_image +
                        '" alt="' +
                        name_image +
                        '" src="' +
              ...
              if (jsonData.product_attribute_one_img) {
                ...
                for (
                  i = 0;
                  i < jsonData.product_attribute_one_img.length;
                  i++
                ) {
              ...
              if (jsonData.product_attribute) {
                if (
                  ...
                  $.each(jsonData.product_attribute.attribute, function (
                    key,
                    value,
                  ) {
                ...
                if (typeof jsonData.product_attribute.size !== 'undefined') {
                  $.each(jsonData.product_attribute.size, function (
                    key,
                    value,
                  ) {

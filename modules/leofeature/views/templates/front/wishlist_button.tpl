<div class="wislish-button relative">
  <a
    ...
    rel="nofollow"
  >
    <span class="bottom-[2px] -right-1 absolute w-full ap-total ap-total-wishlist aspect-square bg-main bottom-0 h-[15px] leading-none max-w-[15px] overflow-hidden pt-0.5 rounded-full text-[12px] text-center text-ellipsis text-white text-xs empty:invisible peer z-30">{if $logged}{WishList::getAllProductsFromDefault($customer.id)}{/if}</span>

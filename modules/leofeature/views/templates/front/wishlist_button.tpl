<div class="wislish-button relative">
  ...
  >
    ...
    <svg class="z-10 fill-current text-main-dark hover:text-main transition visible peer-[:empty]:invisible" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none">
    ...
    <svg class="z-20 absolute left-0 fill-current text-main-dark hover:text-main transition invisible peer-[:empty]:visible" xmlns="http://www.w3.org/2000/svg" width="29" height="29" fill="none">

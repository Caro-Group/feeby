<div class="wislish-button relative mt-[6px]">
  <a
    class="ap-btn-wishlist relative mr-5 block"
    href="{url entity='module' name='leofeature' controller='mywishlist'}"
    title=""
    rel="nofollow"
  >
    <span class="bottom-[3px] -right-1 absolute w-full ap-total ap-total-wishlist aspect-square bg-main bottom-0 h-[15px] leading-none max-w-[15px] overflow-hidden pt-0.5 rounded-full text-[12px] text-center text-ellipsis text-white text-xs empty:invisible peer z-20"></span>
    ...
    <svg class="z-10 absolute left-0 z-50 fill-current text-main-dark hover:text-main transition visible peer-[:empty]:invisible" xmlns="http://www.w3.org/2000/svg" width="29" height="29" fill="none">

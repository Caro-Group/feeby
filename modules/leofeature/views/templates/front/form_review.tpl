	...
	<div class="new_review_form_content p-0 flex-[1_1_50%] mb-[20px]">
		...
		<form class="form-new-review flex flex-row flex-wrap" action="#" method="post">
			<div class="flex flex-col flex-wrap w-full tablet:w-1/2 tablet:pr-[20px] mb-[15px]">
				<label class="text-gray-3000 text-[20px] px-[20px]" for="new_review_title">{l s='Your title' d='Modules.Leofeature.Shop'}</label>
			...
			<div class="flex flex-col flex-wrap w-full tablet:w-1/2 mb-[15px]">
				<label class="text-gray-3000 text-[20px] px-[20px]" for="new_review_customer_name">{l s='Your pseudonim' d='Modules.Leofeature.Shop'}</label>
			...
			<div class="flex flex-col flex-wrap w-full mb-[15px]">
				<label class="text-gray-3000 text-[20px] px-[20px]" for="new_review_content">{l s='Your comment' d='Modules.Leofeature.Shop'}</label>

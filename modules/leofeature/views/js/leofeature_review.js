...
function activeEventFormReview()
{
	$('[data-review-form] .form-new-review').submit(function(){
		...
		$('[data-review-form] .leo-modal-review-bt').click(function(){
			if (!$(this).hasClass('active'))
			{
				$(this).addClass('active');
				...
				else
				{
					...
					$.ajax({
						...
						async: true,
						cache: false,
						data: $( "[data-review-form] .new_review_form_content input, [data-review-form] .new_review_form_content textarea" ).serialize(),
						success: function (result)
						{
							if (result != '')
							{

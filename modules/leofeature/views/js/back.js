...
$(document).ready(function () {
  ...
  var id_panel = $('#leofeature-setting .leofeature-tablist li.active a').attr(
    'href',
  )
  $(id_panel).addClass('active').show()
  $('.leofeature-tablist li').on('click', function () {
      ...
      success: function (result) {
        if (result != '') {
          ...
          if (obj.number_review > 0) {
            ...
            $('#subtab-AdminLeofeatureReviews').append(
              '<div class="notification-container"><span class="notification-counter">' +
                obj.number_review +
                '</span></div>',
            )
          }

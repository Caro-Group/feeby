...
!(function (t) {
              ...
              e.velocity(
                ...
                function () {
                  e.position().top >= 0
                    ...
                    : e.position().top + e.height() <= (0, a.default)(".js-modal-mask").height() &&
                      (0, a.default)(".js-modal-arrow-down").css("opacity", ".2");
                }
              );
            },
          },
    ...
    !(function (t) {
      function e(t) {
        ...
        return (
          "function" !== i &&
          !n.isWindow(t) &&
          (!(1 !== t.nodeType || !e) || "array" === i || 0 === e || ("number" == typeof e && e > 0 && e - 1 in t))
        );
      }
      if (!t.jQuery) {
        ...
        for (
          var r = {}, o = r.hasOwnProperty, a = r.toString, s = "Boolean Number String Function Array Date RegExp Object Error".split(" "), l = 0;
          l < s.length;
          l++
        )
        ...
        return (function (t, e, n, i) {
          ...
          function s(t, e) {
            ...
            n &&
              n.delayTimer &&
              !n.delayPaused &&
              ((n.delayRemaining = n.delay - e + n.delayBegin), (n.delayPaused = !0), clearTimeout(n.delayTimer.setTimeout));
          }
                      ...
                      for (var D in T)
                        if (T.hasOwnProperty(D) && "element" !== D) {
                          ...
                          if (((N.currentValue = P), "tween" === D)) g = P;
                            ...
                            var M = C.setPropertyValue(
                              A,
                              D,
                              N.currentValue + (m < 9 && 0 === parseFloat(P) ? "" : N.unitType),
                              N.rootPropertyValue,
                              N.scrollData
                            );
                            C.Hooks.registered[D] &&
                              (C.Normalizations.registered[V]
                                ? (a(A).rootPropertyValueCache[V] = C.Normalizations.registered[V]("extract", null, M[1]))
                                : (a(A).rootPropertyValueCache[V] = M[1])),
                              "transform" === M[0] && (I = !0);
                          }
                        }
          ...
          function p(t, e) {
            ...
            for (
              var n = E.State.calls[t][0], r = E.State.calls[t][1], o = E.State.calls[t][2], s = E.State.calls[t][4], l = !1, u = 0, c = n.length;
              u < c;
              u++
            ) {
              var f = n[u].element;
              e ||
                o.loop ||
                ("none" === o.display && C.setPropertyValue(f, "display", o.display),
                "hidden" === o.visibility && C.setPropertyValue(f, "visibility", o.visibility));
              var d = a(f);
          ...
          var h,
            ...
            _ = {
              ...
              isWrapped: function (t) {
                return (
                  t && t !== e && _.isNumber(t.length) && !_.isString(t) && !_.isFunction(t) && !_.isNode(t) && (0 === t.length || _.isNode(t[0]))
                );
              },
              isSVG: function (t) {
          ...
          e.pageYOffset !== i
            ...
            : ((E.State.scrollAnchor = n.documentElement || n.body.parentNode || n.body),
          ...
          var C = (E.CSS = {
            ...
            Hooks: {
              ...
              cleanRootPropertyValue: function (t, e) {
                return (
                  C.RegEx.valueUnwrap.test(e) && (e = e.match(C.RegEx.valueUnwrap)[1]), C.Values.isCSSNullValue(e) && (e = C.Hooks.templates[t][1]), e
                );
              },
                    ...
                    case "extract":
                      ...
                      return (
                        C.RegEx.wrappedValueAlreadyExtracted.test(n)
                          ? (i = n)
                          : ((i = n.toString().match(C.RegEx.valueUnwrap)), (i = i ? i[1].replace(/,(\s+)?/g, " ") : n)),
                        i
                      );
                    case "inject":
                      return "rect(" + n + ")";
                      ...
                      switch (e) {
                        ...
                        case "extract":
                          ...
                          if (C.RegEx.wrappedValueAlreadyExtracted.test(r)) o = r;
                            ...
                            /^[A-z]+$/i.test(r)
                              ? (a = s[r] !== i ? s[r] : s.black)
                              : C.RegEx.isHex.test(r)
                              ? (a = "rgb(" + C.Values.hexToRgb(r).join(" ") + ")")
                        ...
                        case "inject":
                          return /^rgb/.test(r)
                            ? r
                            : (m <= 8
                                ? 4 === r.split(" ").length && (r = r.split(/\s+/).slice(0, 3).join(" "))
            ...
            getPropertyValue: function (t, n, r, o) {
              function s(t, n) {
                ...
                if (m <= 8) r = h.css(t, n);
                  ...
                  var l = !1;
                  /^(width|height)$/.test(n) &&
                    0 === C.getPropertyValue(t, "display") &&
                    ((l = !0), C.setPropertyValue(t, "display", C.Values.getDisplayType(t)));
                  var u = function () {
              ...
              if (C.Hooks.registered[n]) {
                ...
                (f = C.Normalizations.registered[n]("name", t)),
                  "transform" !== f &&
                    ((d = s(t, C.Names.prefixCheck(f)[0])), C.Values.isCSSNullValue(d) && C.Hooks.templates[n] && (d = C.Hooks.templates[n][1])),
              ...
              if ("scroll" === n)
                ...
                if (
                  (C.Normalizations.registered[n] &&
                    ((i = C.Normalizations.registered[n]("inject", t, i)), (n = C.Normalizations.registered[n]("name", t))),
          ...
          var A = function t() {
            ...
            function u(t, r) {
              function o(o) {
                ...
                if ("scroll" === P) {
                  ...
                  l.container
                    ? _.isWrapped(l.container) || _.isNode(l.container)
                      ? ((l.container = l.container[0] || l.container),
                        ...
                        (v = m + h(t).position()[x.toLowerCase()] + T))
                      : (l.container = null)
                    : ((m = E.State.scrollAnchor[E.State["scrollProperty" + x]]),
                      (g = E.State.scrollAnchor[E.State["scrollProperty" + ("Left" === x ? "Top" : "Left")]]),
                      (v = h(t).offset()[x.toLowerCase()] + T)),
                    (u = {
                      scroll: {
                        rootPropertyValue: !1,
                        startValue: m,
                  ...
                  var N = function (r, o) {
                    ...
                    if (!((c && c.isSVG) || "tween" === f || !1 !== C.Names.prefixCheck(f)[1] || C.Normalizations.registered[f] !== i))
                      return void E.debug;
                    ((l.display !== i && null !== l.display && "none" !== l.display) || (l.visibility !== i && "hidden" !== l.visibility)) &&
                    ...
                    a ||
                      ...
                      "%" === b &&
                        (/^(fontSize|lineHeight)$/.test(r)
                          ...
                          : /^scale/.test(r)
                          ? ((m /= 100), (b = ""))
                          : /(Red|Green|Blue)$/i.test(r) && ((m = (m / 100) * 255), (b = ""))));
                    if (/[\/*]/.test(x)) b = w;
                    else if (w !== b && 0 !== v)
                      if (0 === m) b = w;
                      else {
                    ...
                    if (w.hasOwnProperty(L)) {
                      ...
                      if (b(C.Lists.colors, j)) {
                        ...
                        if (C.RegEx.isHex.test(V)) {
                          for (
                            var W = ["Red", "Green", "Blue"], U = C.Values.hexToRgb(V), q = H ? C.Values.hexToRgb(H) : i, z = 0;
                            z < W.length;
                            z++
                          ) {
                            var $ = [U[z]];
                ...
                u.element &&
                  ...
                  I === O - 1
                    ? (E.State.calls.push([M, y, l, null, A.resolver, null, 0]), !1 === E.State.isTicking && ((E.State.isTicking = !0), d()))
                    : I++);
              }
              var s,
              ...
              if (
                (!1 !== E.mock &&
                  (!0 === E.mock ? (l.duration = l.delay = 1) : ((l.duration *= parseFloat(E.mock) || 1), (l.delay *= parseFloat(E.mock) || 1))),
                ...
                l.display !== i &&
                  null !== l.display &&
                  ((l.display = l.display.toString().toLowerCase()), "auto" === l.display && (l.display = E.CSS.Values.getDisplayType(t))),
            ...
            var c,
              ...
              T =
                arguments[0] &&
                (arguments[0].p ||
                  (h.isPlainObject(arguments[0].properties) && !arguments[0].properties.names) ||
                  _.isString(arguments[0].properties));
            _.isWrapped(this)
              ? ((m = !1), (v = 0), (y = this), (g = this))
              : ((m = !0), (v = 1), (y = T ? arguments[0].elements || arguments[0].e : arguments[0]));
            var A = {
              promise: null,
              resolver: null,
              rejecter: null,
            ...
            if (
              ...
              T
                ? ((w = arguments[0].properties || arguments[0].p), (S = arguments[0].options || arguments[0].o))
                    ...
                    return (
                      ...
                      h.each(y, function (t, e) {
                        parseFloat(c.stagger)
                          ...
                          : _.isFunction(c.stagger) && (c.delay = B + c.stagger.call(e, t, O)),
                          c.drag &&
                            ((c.duration = parseFloat(j) || (/^(callout|transition)/.test(w) ? 1e3 : x)),
                            (c.duration = Math.max(c.duration * (c.backwards ? 1 - t / O : (t + 1) / O), 0.75 * c.duration, 200))),
    ...
    function r() {
      a.default.each((0, a.default)(u), function (t, e) {
        (0, a.default)(e).TouchSpin({
          ...
          buttonup_class:
            "js-touchspin js-increase-product-quantity block border-0 h-[25px] w-5 relative bg-gray-2000 hover:bg-gray-300 rounded-tr-md transition cursor-pointer",
          buttondown_class:
            "js-touchspin js-decrease-product-quantity block  border-0 h-[25px] w-5 relative bg-gray-2000 hover:bg-gray-300 rounded-br-md transition cursor-pointer",
      ...
      1 === (0, s.default)("body#checkout").length && (r(), o()),
        u.default.on("updatedDeliveryForm", function (t) {
          void 0 !== t.deliveryOption &&
            ...
            ((0, s.default)(".carrier-extra-content").hide(), t.deliveryOption.next(".carrier-extra-content").slideDown());
        });
    });
  },
  function (t, e, n) {
              ...
              value: function () {
                (0, u.default)("#header").toggleClass("is-open"),
                  (0, u.default)("#mobile_top_menu_wrapper").is(":visible")
                    ...
                    : (0, u.default)("#notifications, #wrapper, #footer").show();
              },
            },
          ]),
          e
        ...
        disabled: function (t) {
          if (!0 === t)
            this.options.disabled ||
              (this.$element.attr("disabled", "true"), this.$elementFilestyle.find("label").attr("disabled", "true"), (this.options.disabled = !0));
          else {
            if (!1 !== t) return this.options.disabled;
            this.options.disabled &&
              (this.$element.removeAttr("disabled"), this.$elementFilestyle.find("label").removeAttr("disabled"), (this.options.disabled = !1));
          }
        },
        buttonBefore: function (t) {
          if (!0 === t)
            this.options.buttonBefore ||
              ((this.options.buttonBefore = !0), this.options.input && (this.$elementFilestyle.remove(), this.constructor(), this.pushNameFiles()));
          else {
            if (!1 !== t) return this.options.buttonBefore;
            this.options.buttonBefore &&
              ((this.options.buttonBefore = !1), this.options.input && (this.$elementFilestyle.remove(), this.constructor(), this.pushNameFiles()));
          }
        },
        icon: function (t) {
        ...
        constructor: function () {
          ...
          ("" !== r && r) ||
            ...
            n.$elementFilestyle
              ...
              .attr("tabindex", "0")
              .keypress(function (t) {
                if (13 === t.keyCode || 32 === t.charCode) return n.$elementFilestyle.find("label").trigger("click"), !1;
              }),
            n.$element
              .css({
                position: "absolute",
                ...
                if (!h) {
                  ...
                  if (
                    ...
                    e.linear
                      ...
                      : ((u = Math.max(3, parseInt(0.3 * (l - f[0][e.scrollOffset]), 10))), (s = Math.min(f[0][e.scrollOffset] + u, l))),
                ...
                if (!h) {
                  ...
                  if (
                    (e.linear
                      ...
                      : ((u = Math.max(3, parseInt(0.3 * f[0][e.scrollOffset], 10))), (s = Math.max(f[0][e.scrollOffset] - u, 0))),
                    (f[0][e.scrollOffset] = s),
                    0 === s)
                  ) {
                    if (
  ...
  function (t, e, n) {
    ...
    function r(t) {
      ...
      if (window.innerWidth >= 768) {
        ...
        (0, a.default)("#js-product-list .products").append(t.rendered_products)
      }
              ...
              : n.on("click", function (t) {
                  (0, a.default)(t.target).hasClass("arrow-up") && (0, a.default)(".js-qv-product-images").position().top < 0
                    ...
                    : (0, a.default)(t.target).hasClass("arrow-down") &&
                      i.position().top + i.height() > (0, a.default)(".js-qv-mask").height() &&
                      (e("down"), (0, a.default)(".arrow-up").css("opacity", "1"));
                }),
          ...
          e.velocity(
            ...
            function () {
              e.position().top >= 0
                ...
                : e.position().top + e.height() <= (0, a.default)(".js-qv-mask").height() && (0, a.default)(".arrow-down").css("opacity", ".2");
            }
          );
        };
      ...
      function e() {
        (0, o.default)("#main .js-qv-product-images li").length > 2
          ? ((0, o.default)("#main .js-qv-mask").addClass("scroll"),
            ...
            (0, o.default)(".scroll-box-arrows .right").on("click", function () {
        ...
        return this.each(function () {
          ...
          function d(e) {
            ...
            r.hasClass("input-group-btn")
              ? ((n = '<button class="' + C.buttondown_class + ' bootstrap-touchspin-down" type="button">' + C.buttondown_txt + "</button>"),
                r.append(n))
              : ((n =
              ...
              o.hasClass("input-group-btn")
                ? ((i = '<button class="' + C.buttonup_class + ' bootstrap-touchspin-up" type="button">' + C.buttonup_txt + "</button>"),
                  o.prepend(i))
                : ((i =
                    '<span class="input-group-btn"><button class="' +
                    C.buttonup_class +
          ...
          function p() {
            ...
            (e = C.verticalbuttons
              ? '<div class="input-group bootstrap-touchspin"><span class="input-group-addon bootstrap-touchspin-prefix">' +
                ...
                C.postfix +
                '</span><span class="flex flex-col relative z-10"><button class="' +
                C.buttonup_class +
          ...
          !(function () {
            L.data("alreadyinitialized") ||
              ...
              (i += 1),
              L.data("spinnerid", i),
              L.is("input") && (l(), a(), b(), f(), h(), m(), g(), v(), O.input.css("display", "block")));
          })();
        });
      };
    })(jQuery);
                    ...
                    (e.prototype._removeElement = function (e) {
                      return (
                        ...
                        o.supportsTransitionEnd() && t(e).hasClass(c.FADE)
                          ? void t(e).one(o.TRANSITION_END, t.proxy(this._destroyElement, this, e)).emulateTransitionEnd(150)
                      ...
                      e || (this._isPaused = !1),
                        ...
                        this._config.interval &&
                          ...
                          (this._interval = setInterval(
                            t.proxy(document.visibilityState ? this.nextWhenVisible : this.next, this),
                            this._config.interval
                          ));
                    }),
                    ...
                    (l.prototype._addEventListeners = function () {
                      this._config.keyboard && t(this._element).on(p.KEYDOWN, t.proxy(this._keydown, this)),
                        "hover" !== this._config.pause ||
                          ...
                          t(this._element).on(p.MOUSEENTER, t.proxy(this.pause, this)).on(p.MOUSELEAVE, t.proxy(this.cycle, this));
                    }),
                  ...
                  return (
                    ...
                    (s.prototype.show = function () {
                      ...
                      if (!this._isTransitioning && !t(this._element).hasClass(d.IN)) {
                        var n = void 0,
                          i = void 0;
                        if (
                          (this._parent && ((n = t.makeArray(t(h.ACTIVES))), n.length || (n = null)),
                    ...
                    (s._jQueryInterface = function (e) {
                      return this.each(function () {
                        ...
                        if (
                          (!r && o.toggle && /show|hide/.test(e) && (o.toggle = !1), r || ((r = new s(this, o)), n.data(a, r)), "string" == typeof e)
                        ) {
                  ...
                  return (
                    (e.prototype.toggle = function () {
                      ...
                      return (
                        ...
                        !a.isDefaultPrevented() &&
                          (this.focus(), this.setAttribute("aria-expanded", "true"), t(n).toggleClass(c.OPEN), t(n).trigger(t.Event(u.SHOWN, o)), !1)
                      );
                    }),
                    (e.prototype.dispose = function () {
                    ...
                    (e._clearMenus = function (n) {
                      if (!n || 3 !== n.which) {
                        ...
                        for (var r = t.makeArray(t(f.DATA_TOGGLE)), o = 0; o < r.length; o++) {
                          ...
                          if (
                            t(a).hasClass(c.OPEN) &&
                            !(n && "click" === n.type && /input|textarea/i.test(n.target.tagName) && t.contains(a, n.target))
                          ) {
                            var l = t.Event(u.HIDE, s);
                            t(a).trigger(l),
                              l.isDefaultPrevented() ||
                                (r[o].setAttribute("aria-expanded", "false"), t(a).removeClass(c.OPEN).trigger(t.Event(u.HIDDEN, s)));
                          }
                        }
                      }
                    }),
                    ...
                    (e._dataApiKeydownHandler = function (n) {
                      if (
                        ...
                        (n.preventDefault(), n.stopPropagation(), !this.disabled && !t(this).hasClass(c.DISABLED))
                      ) {
                  ...
                  return (
                    ...
                    (l.prototype.hide = function (e) {
                      ...
                      t(this._element).trigger(n),
                        this._isShown &&
                          ...
                          o.supportsTransitionEnd() && t(this._element).hasClass(d.FADE)
                            ? t(this._element).one(o.TRANSITION_END, t.proxy(this._hideModal, this)).emulateTransitionEnd(300)
                            : this._hideModal());
                    }),
                    (l.prototype.dispose = function () {
                      t.removeData(this._element, a),
                    ...
                    (l.prototype._showBackdrop = function (e) {
                      ...
                      if (this._isShown && this._config.backdrop) {
                        ...
                        o.supportsTransitionEnd() && t(this._element).hasClass(d.FADE)
                          ? t(this._backdrop).one(o.TRANSITION_END, a).emulateTransitionEnd(150)
                          : a();
                      } else e && e();
                    }),
                  ...
                  return (
                    ...
                    (l.prototype._activate = function (e) {
                      ...
                      i.hasClass(d.DROPDOWN_ITEM)
                        ? (i.closest(p.DROPDOWN).find(p.DROPDOWN_TOGGLE).addClass(d.ACTIVE), i.addClass(d.ACTIVE))
                  ...
                  return (
                    ...
                    (e.prototype._transitionComplete = function (e, n, i, r) {
                      ...
                      if (
                        ...
                        i ? (o.reflow(e), t(e).addClass(u.IN)) : t(e).removeClass(u.FADE),
                  ...
                  (t.flexStyle = n
                    ...
                    "content-box" === t.style.boxSizing &&
                      ("number" == typeof t.flexStyle.main &&
                        (t.flexStyle.main +=
                          t.flexStyle.mainInnerBefore + t.flexStyle.mainInnerAfter + t.flexStyle.mainBorderBefore + t.flexStyle.mainBorderAfter),
                      "number" == typeof t.flexStyle.cross &&
                        (t.flexStyle.cross +=
                          t.flexStyle.crossInnerBefore + t.flexStyle.crossInnerAfter + t.flexStyle.crossBorderBefore + t.flexStyle.crossBorderAfter));
  ...
  function (t, e, n) {
    ...
    !(function (a) {
      n(6) && n(6).jQuery
        ? ((r = [n(0)]), (i = a), void 0 !== (o = "function" == typeof i ? i.apply(e, r) : i) && (t.exports = o))
        : a(void 0 !== t && t.exports ? n(0) : jQuery);
    })(function (t) {
      function e(e) {
        return (
      ...
      function n(e, n) {
          ...
          if (!(ut() || t(e.target).closest(n.excludedElements, zt).length > 0)) {
            ...
            if (!i.pointerType || "mouse" != i.pointerType || 0 != n.fallbackToMouseEvents) {
              ...
              return (
                ...
                st(),
                ft(0, a),
                !o || Qt === n.fingers || n.fingers === y || U()
                  ? ((Yt = Tt()),
                    2 == Qt && (ft(1, o[1]), (Mt = Rt = bt(Gt[0].start, Gt[1].start))),
                    (n.swipeStatus || n.pinchStatus) && (r = j(i, $t)))
                  : (r = !1),
                !1 === r
                  ? (($t = S), j(i, $t), r)
                  : (n.hold &&
        ...
        function I(t) {
          ...
          if ($t !== x && $t !== S && !lt()) {
            ...
            if (
              ...
              2 == Qt &&
                (0 == Mt
                  ? (ft(1, r[1]), (Mt = Rt = bt(Gt[0].start, Gt[1].start)))
                  : (dt(r[1]), (Rt = bt(Gt[0].end, Gt[1].end)), (Ut = wt(Gt[0].end, Gt[1].end))),
                (Ht = _t(Mt, Rt)),
                (Wt = Math.abs(Mt - Rt))),
        ...
        function L(t) {
          ...
          return (
            !i || o
              ? (e = S)
              : !r || t != w || (n.triggerOnTouchEnd && !n.triggerOnTouchLeave)
              ? !r && t == x && n.triggerOnTouchLeave && (e = S)
              : (e = x),
            e
          );
        }
        ...
        function B(e, u, c) {
          ...
          if (c == f) {
            if (
              (zt.trigger("swipeStatus", [u, Bt || null, jt || 0, Ft || 0, Qt, Gt, Vt]),
              n.swipeStatus && !1 === (g = n.swipeStatus.call(zt, e, u, Bt || null, jt || 0, Ft || 0, Qt, Gt, Vt)))
            )
              return !1;
            if (u == x && z()) {
              if (
                (clearTimeout(te),
                clearTimeout(ee),
                zt.trigger("swipe", [Bt, jt, Ft, Qt, Gt, Vt]),
                n.swipe && !1 === (g = n.swipe.call(zt, e, Bt, jt, Ft, Qt, Gt, Vt)))
              )
                return !1;
              switch (Bt) {
                case i:
          ...
          if (c == d) {
            if (
              (zt.trigger("pinchStatus", [u, Ut || null, Wt || 0, Ft || 0, Qt, Ht, Gt]),
              n.pinchStatus && !1 === (g = n.pinchStatus.call(zt, e, u, Ut || null, Wt || 0, Ft || 0, Qt, Ht, Gt)))
            )
              return !1;
            if (u == x && W())
              switch (Ut) {
          ...
          return (
            c == p
              ...
              ? (u !== S && u !== x) ||
                ...
                n.doubleTap && (g = n.doubleTap.call(zt, e, e.target)))
              : c == m &&
                ((u !== S && u !== x) ||
                  (clearTimeout(te), (Jt = null), zt.trigger("longtap", [e.target]), n.longTap && (g = n.longTap.call(zt, e, e.target)))),
            g
          );
        }
        ...
        function ct(t) {
          zt &&
            (!0 === t ? (zt.on(Dt, I), zt.on(Pt, k), Nt && zt.on(Nt, P)) : (zt.off(Dt, I, !1), zt.off(Pt, k, !1), Nt && zt.off(Nt, P, !1)),
            zt.data(A + "_intouch", !0 === t));
        }
    ...
    !(function (o, a) {
      ...
      var B = E.Utils,
        ...
        V = (function () {
          ...
          for (
            var t = document.createElement("div"), e = ["transform", "WebkitTransform", "OTransform", "MozTransform", "msTransform"], n = 0;
            n < e.length;
            ++n
          ) {
            var i = e[n];
                ...
                value: function () {
                  ...
                  if ("scroll-handle" === this.targetModifier) {
                    ...
                    var a = t.height - parseFloat(i.borderTopWidth) - parseFloat(i.borderBottomWidth) - o,
                      ...
                      l = 0;
                    a < 408 && this.target === document.body && (l = -11e-5 * Math.pow(a, 2) - 0.00727 * a + 22.58),
                      this.target !== document.body && (e.height = Math.max(e.height, 24));
                    var u = this.target.scrollTop / (n.scrollHeight - a);
                    return (
                      (e.top = u * (a - e.height - l) + t.top + parseFloat(i.borderTopWidth)),
                      this.target === document.body && (e.height = Math.max(e.height, 24)),
                      e
                    );
                  }
        ...
        position: function (t) {
          ...
          return (
            this.options.constraints.forEach(function (t) {
              ...
              var b = x(e, o);
              ("target" !== f && "both" !== f) ||
                (n < b[1] && "top" === v.top && ((n += d), (v.top = "bottom")), n + a > b[3] && "bottom" === v.top && ((n -= d), (v.top = "top"))),
                "together" === f &&
                  ("top" === v.top &&
                    ("bottom" === y.top && n < b[1]
                  ...
                  "middle" === v.top &&
                    (n + a > b[3] && "top" === y.top
                      ? ((n -= a), (y.top = "bottom"))
                      : n < b[1] && "bottom" === y.top && ((n += a), (y.top = "top")))),
                ("target" !== c && "both" !== c) ||
                  (i < b[0] && "left" === v.left && ((i += p), (v.left = "right")),
                  i + l > b[2] && "right" === v.left && ((i -= p), (v.left = "left"))),
                "together" === c &&
                  (i < b[0] && "left" === v.left
                    ? "right" === y.left
                    ...
                    : "center" === v.left &&
                      (i + l > b[2] && "left" === y.left
                        ? ((i -= l), (y.left = "right"))
                        : i < b[0] && "right" === y.left && ((i += l), (y.left = "left")))),
                ("element" !== f && "both" !== f) ||
                  (n < b[1] && "bottom" === y.top && ((n += a), (y.top = "top")), n + a > b[3] && "top" === y.top && ((n -= a), (y.top = "bottom"))),
                ("element" !== c && "both" !== c) ||

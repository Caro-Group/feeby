        ...
        return (function (t, e, n, i) {
          ...
          function d(t) {
            if (t) {
              ...
              n > 1e4 &&
                ((E.State.calls = r(E.State.calls)), (n = E.State.calls.length))
              for (var o = 0; o < n; o++)
                if (E.State.calls[o]) {
                  ...
                  b = s[6] = e - c
                  for (
                    var w = Math.min(b / u.duration, 1), x = 0, S = l.length;
                    x < S;
                    x++
                  ) {
                    var T = l[x],
                    ...
                    if (a(A)) {
                      ...
                      u.visibility !== i &&
                        'hidden' !== u.visibility &&
                        C.setPropertyValue(A, 'visibility', u.visibility)
                      for (var D in T)
                        if (T.hasOwnProperty(D) && 'element' !== D) {
                          var P,
                            N = T[D],
                            L = _.isString(N.easing)
                              ? E.Easings[N.easing]
                              : N.easing
          ...
          function p(t, e) {
            ...
            for (
              ...
              e ||
                o.loop ||
                ('none' === o.display &&
                  C.setPropertyValue(f, 'display', o.display),
                'hidden' === o.visibility &&
                  C.setPropertyValue(f, 'visibility', o.visibility))
              var d = a(f)
              if (
                !0 !== o.loop &&
                (h.queue(f)[1] === i ||
          ...
          var C = (E.CSS = {
            ...
            Hooks: {
              ...
              register: function () {
                for (var t = 0; t < C.Lists.colors.length; t++) {
                  var e =
                    'color' === C.Lists.colors[t] ? '0 0 0 1' : '255 255 255 1'
                  C.Hooks.templates[C.Lists.colors[t]] = [
                  ...
                  for (n in C.Hooks.templates)
                    if (C.Hooks.templates.hasOwnProperty(n)) {
                      ...
                      'Color' === r[0] &&
                        (r.push(r.shift()),
                        o.push(o.shift()),
                        (C.Hooks.templates[n] = [r.join(' '), o.join(' ')]))
                    }
                for (n in C.Hooks.templates)
                  if (C.Hooks.templates.hasOwnProperty(n)) {
                    ;(i = C.Hooks.templates[n]), (r = i[0].split(' '))
              ...
              fixColors: function (t) {
                return t.replace(/(rgba?\(\s*)?(\b[a-z]+\b)/g, function (
                  ...
                  return C.Lists.colorNames.hasOwnProperty(n)
                    ? (e || 'rgba(') + C.Lists.colorNames[n] + (e ? '' : ',1)')
                    : e + n
                })
              },
              cleanRootPropertyValue: function (t, e) {
                return (
                  C.RegEx.valueUnwrap.test(e) &&
                    (e = e.match(C.RegEx.valueUnwrap)[1]),
              ...
              extractValue: function (t, e) {
                ...
                if (n) {
                  var i = n[0],
                    r = n[1]
                  return (
                    (e = C.Hooks.cleanRootPropertyValue(i, e)),
              ...
              injectValue: function (t, e, n) {
                ...
                if (i) {
                  var r,
                    ...
                    a = i[1]
                  return (
                    (n = C.Hooks.cleanRootPropertyValue(o, n)),
            ...
            Normalizations: {
                    ...
                    case 'extract':
                      ...
                      return (
                        C.RegEx.wrappedValueAlreadyExtracted.test(n)
                          ? (i = n)
                          : ((i = n.toString().match(C.RegEx.valueUnwrap)),
              ...
              register: function () {
                function t(t, e, n) {
                  if (
                    ('border-box' ===
                      C.getPropertyValue(e, 'boxSizing')
                        .toString()
                        .toLowerCase()) ===
                    (n || !1)
                  ) {
                    ...
                    for (i = 0; i < s.length; i++)
                      (r = parseFloat(C.getPropertyValue(e, s[i]))),
                        isNaN(r) || (o += r)
                    return n ? -o : o
                  }
                  return 0
                ...
                ;(m && !(m > 9)) ||
                  ...
                  (C.Lists.transformsBase = C.Lists.transformsBase.concat(
                    C.Lists.transforms3D,
                  ))
            ...
            getPropertyValue: function (t, n, r, o) {
                ...
                if (m <= 8) r = h.css(t, n)
                  ...
                  if (!o) {
                    if (
                      'height' === n &&
                      'border-box' !==
                        C.getPropertyValue(t, 'boxSizing')
                          .toString()
                          .toLowerCase()
                    ) {
                      var c =
                        t.offsetHeight -
                        (parseFloat(C.getPropertyValue(t, 'borderTopWidth')) ||
                          0) -
                        (parseFloat(
                          C.getPropertyValue(t, 'borderBottomWidth'),
                        ) || 0) -
                        (parseFloat(C.getPropertyValue(t, 'paddingTop')) || 0) -
                        (parseFloat(C.getPropertyValue(t, 'paddingBottom')) ||
                          0)
                      return u(), c
                    }
                    if (
                      ...
                      var f =
                        t.offsetWidth -
                        (parseFloat(C.getPropertyValue(t, 'borderLeftWidth')) ||
                          0) -
                        (parseFloat(
                          C.getPropertyValue(t, 'borderRightWidth'),
                        ) || 0) -
                        (parseFloat(C.getPropertyValue(t, 'paddingLeft')) ||
                          0) -
              ...
              if (C.Hooks.registered[n]) {
                var u = n,
                  c = C.Hooks.getRoot(u)
                r === i &&
                  (r = C.getPropertyValue(t, C.Names.prefixCheck(c)[0])),
                  C.Normalizations.registered[c] &&
                    (r = C.Normalizations.registered[c]('extract', t, r)),
                  (l = C.Hooks.extractValue(u, r))
              } else if (C.Normalizations.registered[n]) {
                var f, d
                ;(f = C.Normalizations.registered[n]('name', t)),
                  'transform' !== f &&
                    ((d = s(t, C.Names.prefixCheck(f)[0])),
                    C.Values.isCSSNullValue(d) &&
                      C.Hooks.templates[n] &&
                      (d = C.Hooks.templates[n][1])),
            ...
            setPropertyValue: function (t, n, i, r, o) {
              ...
              if ('scroll' === n)
                ...
                'transform' === C.Normalizations.registered[n]('name', t)
              )
                C.Normalizations.registered[n]('inject', t, i),
                  (s = 'transform'),
                ...
                if (
                  (C.Normalizations.registered[n] &&
                    ((i = C.Normalizations.registered[n]('inject', t, i)),
                    (n = C.Normalizations.registered[n]('name', t))),
                  ...
                  var c = a(t)
                  c && c.isSVG && C.Names.SVGAttribute(n)
                    ? t.setAttribute(n, i)
                    : (t.style[s] = i)
                }
                E.debug
              ...
              function o(o) {
                ...
                if ('scroll' === P) {
                  ...
                  l.container
                    ? _.isWrapped(l.container) || _.isNode(l.container)
                      ...
                      : (l.container = null)
                    : ((m =
                        E.State.scrollAnchor[E.State['scrollProperty' + x]]),
                      (g =
                        E.State.scrollAnchor[
                          E.State[
                  ...
                  var N = function (r, o) {
                    ...
                    if (
                      !(
                        (c && c.isSVG) ||
                        'tween' === f ||
                        !1 !== C.Names.prefixCheck(f)[1] ||
                        C.Normalizations.registered[f] !== i
                      )
                    )
                      return void E.debug
                    ;((l.display !== i &&
                      ...
                      l._cacheValues && p && p[r]
                        ...
                        ? v === i
                          ? ((d = C.getPropertyValue(t, f)),
                            (v = C.getPropertyValue(t, r, d)))
                    ...
                    if (v !== m && _.isString(v) && _.isString(m)) {
                      ...
                      var T = 0,
                        ...
                        P = 0
                      for (
                        v = C.Hooks.fixColors(v), m = C.Hooks.fixColors(m);
                        T < v.length && A < m.length;
                          ...
                          (function () {
                            ...
                            if (o && r)
                              ...
                              E.init(s),
                                ...
                                (a.percentToPxHeight = F.lastPercentToPxHeight =
                                  (parseFloat(
                                    C.getPropertyValue(s, 'height', null, !0),
                                  ) || 1) / 100),
                                (a.emToPx = F.lastEmToPx =
                                  (parseFloat(
                        ...
                        if (C.RegEx.isHex.test(V)) {
                          for (
                            var W = ['Red', 'Green', 'Blue'],
                              U = C.Values.hexToRgb(V),
                              q = H ? C.Values.hexToRgb(H) : i,
                              z = 0;
                            z < W.length;
                            z++
                          ) {
                ...
                u.element &&
                  ...
                  c &&
                    ...
                    (c.isAnimating = !0)),
                  I === O - 1
                    ? (E.State.calls.push([M, y, l, null, A.resolver, null, 0]),
                      !1 === E.State.isTicking &&
                      ...
                      h.each(y, function (t, e) {
                        parseFloat(c.stagger)
                          ...
                          : _.isFunction(c.stagger) &&
                            (c.delay = B + c.stagger.call(e, t, O)),
                          c.drag &&
                            ((c.duration =
                              parseFloat(j) ||
    ...
    function r() {
      a.default.each((0, a.default)(u), function (t, e) {
        ;(0, a.default)(e).TouchSpin({
          verticalbuttons: !0,
          verticalupclass:
            'material-icons touchspin-up  absolute w-full top-0 text-xl left-0',
          verticaldownclass:
            'material-icons touchspin-down  absolute w-full bottom-2 text-xl left-0',
          buttonup_class:
          ...
          a(e, [
            {
              ...
              value: function () {
                ...
                this.el.find('li').on('hover', function (e) {
                  ...
                  (0, u.default)('.js-top-menu .category').on(
                    'mouseleave',
                    function () {
      ...
      t.fn.TouchSpin = function (e) {
        ...
        return this.each(function () {
          ...
          function s(t) {
            ...
            var e = O.input.val()
            '' !== e &&
              ((e = Number(O.input.val())), O.input.val(e.toFixed(C.decimals)))
          }
          ...
          function g() {
            L.on('keydown', function (t) {
              ...
              38 === e
                ? ('up' !== V && (w(), E()), t.preventDefault())
                : 40 === e && ('down' !== V && (x(), S()), t.preventDefault())
            }),
              ...
              O.down.on('mouseout touchleave touchend touchcancel', function (
                t,
              ) {
                V && (t.stopPropagation(), T())
              }),
          ...
          function b() {
            ...
            if ('' === (t = L.val()))
              return void (
                '' !== C.replacementval &&
                (L.val(C.replacementval), L.trigger('change'))
              )
            ;(C.decimals > 0 && '.' === t) ||
              ((e = parseFloat(t)),
          ...
          function _() {
            if (C.booster) {
              ...
              return (
                C.maxboostedstep &&
                  t > C.maxboostedstep &&
                  ((t = C.maxboostedstep), (I = Math.round(I / t) * t)),
                Math.max(C.step, t)
              )
            }
            return C.step
  ...
  function (t, e, n) {
    ...
    !(function (a) {
      ...
      function n(e, n) {
        function O(e) {
          if (
            !(ut() || t(e.target).closest(n.excludedElements, zt).length > 0)
          ) {
            ...
            if (
              ...
              return (
                ...
                !o || Qt === n.fingers || n.fingers === y || U()
                  ? ((Yt = Tt()),
                    2 == Qt &&
                      (ft(1, o[1]), (Mt = Rt = bt(Gt[0].start, Gt[1].start))),
            ...
            if (
              ...
              2 == Qt &&
                (0 == Mt
                  ...
                  : (dt(r[1]),
                    (Rt = bt(Gt[0].end, Gt[1].end)),
                    (Ut = wt(Gt[0].end, Gt[1].end))),
                (Ht = _t(Mt, Rt)),
                (Wt = Math.abs(Mt - Rt))),
          ...
          if (c == f) {
            ...
            if (u == x && z()) {
              if (
                ...
                n.swipe &&
                  !1 === (g = n.swipe.call(zt, e, Bt, jt, Ft, Qt, Gt, Vt)))
              )
                return !1
              switch (Bt) {
                case i:
                  zt.trigger('swipeLeft', [Bt, jt, Ft, Qt, Gt, Vt]),
                    n.swipeLeft &&
                      (g = n.swipeLeft.call(zt, e, Bt, jt, Ft, Qt, Gt, Vt))
                  break
                case r:
                  zt.trigger('swipeRight', [Bt, jt, Ft, Qt, Gt, Vt]),
                    n.swipeRight &&
                      (g = n.swipeRight.call(zt, e, Bt, jt, Ft, Qt, Gt, Vt))
                  break
                case o:
                  zt.trigger('swipeUp', [Bt, jt, Ft, Qt, Gt, Vt]),
                    n.swipeUp &&
                      (g = n.swipeUp.call(zt, e, Bt, jt, Ft, Qt, Gt, Vt))
                  break
                case a:
                  zt.trigger('swipeDown', [Bt, jt, Ft, Qt, Gt, Vt]),
                    n.swipeDown &&
                      (g = n.swipeDown.call(zt, e, Bt, jt, Ft, Qt, Gt, Vt))
              }
            }
          }
          if (c == d) {
            ...
            c == p
              ...
              : c == m &&
                ((u !== S && u !== x) ||
                  ...
                  n.longTap && (g = n.longTap.call(zt, e, e.target)))),
            g
          )
        }
        ...
        function H(t, e) {
          if (!1 !== n.preventDefaultEvents)
            if (n.allowPageScroll === u) t.preventDefault()
              ...
              switch (e) {
                case i:
                  ;((n.swipeLeft && s) || (!s && n.allowPageScroll != g)) &&
                    t.preventDefault()
                  break
                case r:
                  ;((n.swipeRight && s) || (!s && n.allowPageScroll != g)) &&
                    t.preventDefault()
                  break
                case o:
                  ;((n.swipeUp && s) || (!s && n.allowPageScroll != v)) &&
                    t.preventDefault()
                  break
                case a:
                  ;((n.swipeDown && s) || (!s && n.allowPageScroll != v)) &&
                    t.preventDefault()
              }
            }
        }
        ...
        function ct(t) {
          zt &&
            (!0 === t
              ? (zt.on(Dt, I), zt.on(Pt, k), Nt && zt.on(Nt, P))
              : (zt.off(Dt, I, !1), zt.off(Pt, k, !1), Nt && zt.off(Nt, P, !1)),
        ...
        function gt() {
          var t = {}
          return (
            (t[i] = vt(i)), (t[r] = vt(r)), (t[o] = vt(o)), (t[a] = vt(a)), t
          )
        }
                ...
                value: function () {
                  ...
                  if (this.enabled) {
                    ...
                    var S = {
                      ...
                      A = void 0
                    return (
                      C.innerHeight > T.documentElement.clientHeight &&
                        ((A = this.cache('scrollbar-size', u)),
                        (S.viewport.bottom -= A.height)),
                      C.innerWidth > T.documentElement.clientWidth &&
                        ((A = this.cache('scrollbar-size', u)),
                        (S.viewport.right -= A.width)),
                      (-1 !== ['', 'static'].indexOf(T.body.style.position) &&
                        -1 !==
                          ['', 'static'].indexOf(
                            T.body.parentElement.style.position,
                          )) ||
                        ((S.page.bottom = T.body.scrollHeight - v - o),
                        (S.page.right = T.body.scrollWidth - g - r)),
                      void 0 !== this.options.optimizations &&
                        ...
                        (function () {
                          ...
                          if (
                            ...
                            (n.right =
                              T.body.scrollWidth - n.left - r.width + o.right),
                            (n.bottom =
                              T.body.scrollHeight -
                              n.top -
                              r.height +

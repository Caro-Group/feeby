      ...
      {block name='content'}
        <section id="content" class="relative pt-[120px] tablet:pt-40">
          <div class="flex flex-wrap">
            <div class="cart-grid-body flex-auto w-full tablet:w-1/2 tablet-wide:w-2/3 tablet-wide:pr-40">
              {block name='checkout_process'}
                {render file='checkout/checkout-process.tpl' ui=$checkout_process}
              {/block}
            </div>
            <div class="cart-grid-body flex-auto w-full tablet:w-1/2 tablet-wide:w-1/3">

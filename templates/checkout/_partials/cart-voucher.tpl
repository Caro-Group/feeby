...
{if $cart.vouchers.allowed}
  {block name='cart_voucher'}
      <div class="cart-voucher desktop:ml-[122px] tablet:max-w-[370px] w-full my-6 tablet-wide:ml-[122px]">
        <span class="font-body font-normal tablet:text-2xl text-main-dark text-xl ml-5">
          ...
          <div class="promo-code">
            {block name='cart_voucher_form'}
              <form class="border-gray-2000 border-solid border flex rounded-full pl-4 bg-white" action="{$urls.pages.cart}" data-link-action="add-voucher" method="post">
                ...
                <button type="submit" class="bg-main-dark hover:bg-main-hover cursor-pointer overflow-hidden transition border-0 rounded-full text-white px-8 uppercase whitespace-nowrap font-body">

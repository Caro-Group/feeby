...
{block "form_buttons"}
    ...
    <button
      class="w-full text-xs tablet:text-sm tablet:w-auto bg-main hover:opcaity-80 duration-150 border-0 rounded-full text-white p-3 px-4 uppercase whitespace-nowrap mb-2 flex items-center justify-between ml-auto cursor-pointer"
      name="continue"

...
{block name='form_field'}
  ...
  {elseif $field.name eq "phone"}
    ...
    <div class="flex flex-auto flex-col desktop-presta:flex-row mb-form -mt-form">
      <label
        class="font-body font-normal ml-5 mt-3 tablet-medium:ml-0 desktop-presta:w-[220px] text-base tablet:text-xl text-main-dark text-left "></label>
      <div class=" flex-1 ">
  ...
  {block name='form_buttons'}
    {if !$form_has_continue_button}
      <div class="flex flex-wrap">
        <a class="js-cancel-address cancel-address ml-3 cursor-pointer flex items-center justify-between mb-2 text-gray-3000 hover:text-main-dark transition duration-200 uppercase whitespace-nowrap"
    ...
    {else}
      <form>
        ...
        {/if}
        <button type="submit"
          class="continue bg-main ml-auto w-full tablet:w-auto hover:bg-main-hover duration-150 border-0 rounded-full text-white p-2 px-4 uppercase whitespace-nowrap mb-8 tablet:mb-2 cursor-pointer"

      ...
      {if $delivery_options|count}
        ...
        >
          ...
          <div class="flex flex-col-reverse flex-wrap items-baseline justify-between tablet:flex-row tablet:items-center">
            ...
            <button type="submit" class="continue w-full text-xs tablet:text-sm tablet:w-auto bg-main hover:bg-main-hover duration-150 border-0 rounded-full text-white p-2 px-4 uppercase whitespace-nowrap mb-2 flex items-center justify-between ml-auto cursor-pointer" name="confirmDeliveryOption" value="1">

    ...
    <div class="delivery-options-list">
      {if $delivery_options|count}
        ...
        >
              ...
              <div class="delivery-options flex flex-col flex-wrap">
                ...
                {foreach from=$delivery_options item=carrier key=carrier_id name=delivery_options_loop}
                    {if isset($carrier.external_module_name) && $carrier.external_module_name != $carrier_module}
                      <div class="flex flex-row flex-wrap justify-between items-baseline mb-5">
                        <div class="font-body text-base text-main-dark tablet:text-xl font-normal">
          ...
          <div class="flex flex-col-reverse flex-wrap items-baseline justify-between tablet:flex-row tablet:items-center">
            ...
            <button type="submit" class="continue w-full text-xs tablet:text-sm tablet:w-auto bg-main hover:bg-main-hover duration-150 border-0 rounded-full text-white p-3 px-4 uppercase whitespace-nowrap mb-8 tablet:mb-2 flex items-center justify-between ml-auto cursor-pointer" name="confirmDeliveryOption" value="1">

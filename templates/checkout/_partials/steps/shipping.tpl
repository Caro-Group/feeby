        ...
        <form class="clearfix" id="js-delivery"
          ...
          <div
            ...
            <button data-checkout-back="#checkout-personal-information-step"
              class="text-gray-3000 hover:text-main-dark transition duration-200 bg-transparent border-0 uppercase whitespace-nowrap mb-0 flex items-center justify-between cursor-pointer text-sm"><svg

...
{block name='step_content'}
  <div class="p-5 tablet:p-0">
    ...
    <div class="flex flex-wrap-reverse justify-between">
      <button data-checkout-back="#checkout-delivery-step" class="ml-auto text-black bg-transparent border-0 uppercase whitespace-nowrap mb-2 flex items-center justify-between cursor-pointer">
      ...
      <button data-checkout-payment disabled class="bg-main hover:bg-main-hover duration-150 border-0 rounded-full text-white p-2 px-4 uppercase whitespace-nowrap mb-2 flex items-center justify-between cursor-pointer">

...
{block name='step_content'}
  <div class="p-5 tablet:p-0">
    ...
    <div class="flex flex-wrap-reverse justify-between mb-10 tablet:mb-[30px]">
      <button data-checkout-back="#checkout-delivery-step" class="text-main-dark bg-transparent border-0 uppercase whitespace-nowrap flex items-center justify-between cursor-pointer text-sm">

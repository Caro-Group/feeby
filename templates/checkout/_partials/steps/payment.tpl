...
{block name='step_content'}
  <div class="p-5 tablet:p-0">
    <div class="flex flex-row mb-[30px] tablet:mb-14">
      <h2
        class="border-0 border-b-[3px] rounded-b-sm border-main border-solid mb-0 pb-2 tablet:pb-3 font-normal text-xl tablet:text-2xl">
        ...
        {foreach from=$module_options item="option"}
          <div>
            <div id="{$option.id}-container"
              class="bg-gray-1000 flex flex-row mb-2.5 tablet:mb-5 p-5 payment-option min-h-[55px] tablet:min-h-[80px] rounded-md">
              ...
              <span class="flex items-center tablet:ml-[10px]">
                <input
                  ...
                  id="{$option.id}" data-module-name="{$option.module_name}" name="payment-option" type="radio" required
              ...
              <label for="{$option.id}"
                class="cursor-pointer flex flex-auto flex-wrap font-body font-normal justify-between items-center mb-0 ml-[30px] tablet:text-base text-sm">
    ...
    <div id="payment-confirmation" class="!hidden"></div>

    <div class="flex flex-wrap-reverse justify-between mb-10 tablet:mb-[30px]">
      <button data-checkout-back="#checkout-delivery-step"
        class="text-gray-3000 hover:text-main-dark transition duration-200 bg-transparent border-0 uppercase whitespace-nowrap flex items-center justify-between cursor-pointer text-sm">
      ...
      <button data-checkout-payment disabled
        class="w-full text-lg tablet:w-auto ml-auto bg-main-dark hover:bg-main-hover duration-150 border-0 rounded-full text-white p-3 tablet:px-8 uppercase whitespace-nowrap mb-8 tablet:mb-0 flex items-center justify-between cursor-pointer">

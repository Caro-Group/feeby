      ...
      <div class="ml-auto tablet:w-auto w-full">
        <div id="payment-confirmation">
          <div class="ps-shown-by-js">
            <button type="submit" disabled="disabled" class="w-full tablet:w-auto !text-base tablet:!text-lg btn bg-main hover:bg-main-hover duration-150 border-0 rounded-full text-white tablet:p-3 px-4 desktop:px-8 uppercase whitespace-nowrap mb-8 tablet:mb-0 flex items-center justify-between cursor-pointer">

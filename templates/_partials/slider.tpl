...
<div id="{$type}" class="relative overflow-hidden {if $type == "products-crossell" || $type == "products-releated-footer"} -mx-[30px] overflow-hidden {/if}">
    ...
    <div data-swiper-carousel class="swiper ml-5 mr-5 ">
        ...
        <i class="hidden tablet:flex absolute top-1/2 z-50 left-0 ti-arrow-left justify-center items-center w-12 h-12 text-main-dark bg-gray-1000 hover:bg-main-dark hover:text-white rounded-full transition cursor-pointer" data-swiper-product-prev="" tabindex="0" role="button"> </i>
        <i class="hidden tablet:flex absolute top-1/2 z-50 right-0 ti-arrow-right justify-center items-center w-12 h-12 text-main-dark bg-gray-1000 hover:bg-main-dark hover:text-white rounded-full transition cursor-pointer" data-swiper-product-next="" tabindex="0" role="button"> </i>

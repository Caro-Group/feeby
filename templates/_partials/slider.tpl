{if isset($products) && $products}
    <div id="{$type}" class="overflow-hidden {if $type == "products-crossell" || $type == "products-releated-footer"} -mx-[30px] overflow-hidden {/if}">
        ...
        {if !empty($title)}
            <div class="flex justify-between px-[30px] {if $type == "products-crossell" || $type == "products-releated-footer"} tablet-medium:px-[20px] {/if} {if $type == "products-related-footer"} mt-8 tablet:mt-20 {/if} mb-[25px] tablet:mb-6">

            ...
            {elseif $page.type === 'next'}
              <div class="w-full flex justify-center order-2">
                <a rel="next" href="{$page.url}"
                  class="flex items-center bg-main hover:bg-main-hover border-none font-medium font-normal px-6 py-3 rounded-full text-white hover:text-white uppercase cursor-pointer transition duration-150 next {['disabled' => !$page.clickable, 'js-search-link' => true]|classnames}">

...
<form action="{block name='customer_form_actionurl'}{$action}{/block}" id="customer-form" class="js-customer-form" method="post">
  ...
  {block name='customer_form_footer'}
    <footer class="clearfix flex flex-col-reverse form-footer items-baseline items-center tablet:flex-row mb-10 tablet:mb-[30px]">
      ...
      {block "form_buttons"}
        <button class="form-control-submit ml-auto bg-main-dark border-0 cursor-pointer duration-150 flex font-body hover:text-white hover:bg-main-hover items-center justify-between max-w-[320px] mb-3 px-8 py-3 rounded-full text-white text-lg uppercase w-full whitespace-nowrap" data-link-action="save-customer" type="submit">

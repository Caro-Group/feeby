    ...
    {block name='login_form_footer'}
      <footer class="mt-[30px] text-sm-center clearfix">
        ...
        {block name='form_buttons'}
          <button id="submit-login" class="form-control-submit ml-auto bg-main-dark border-0 cursor-pointer duration-150 flex font-body hover:text-white hover:bg-main-hover items-center justify-between max-w-[320px] mb-3 px-8 py-3 rounded-full text-white text-lg uppercase w-full whitespace-nowrap" data-link-action="sign-in" type="submit">

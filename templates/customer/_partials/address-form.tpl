    ...
    {/block}
      ...
      <footer class="flex flex-wrap flex-col-reverse tablet:flex-row items-baseline">
        ...
        {block name='form_buttons'}
          <button class="ml-auto bg-main hover:bg-main-hover duration-150 border-0 rounded-full text-white p-2 px-4 uppercase whitespace-nowrap mt-5 flex items-center justify-between cursor-pointer " type="submit">

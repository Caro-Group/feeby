    ...
    <ul class="ps-alert-error">
      {foreach $errors as $error}
        <li class=" flex justify-center">
          ...
          <p class="text-main-dark font-body text-sm tablet:text-base">{$error}</p>
        </li>
      {/foreach}
    </ul>
    ...
    <section class="form-fields">
      <div class="form-group center-email-fields row">
        <div class="flex w-full items-center flex-wrap tablet:flex-nowrap">
          <input type="email" name="email" id="email" class="tablet:mr-5 mb-5 tablet:mb-0 form-input font-body text-sm  border-gray-2000 border-solid border flex rounded-full pl-4 bg-white w-full focus:border-gray-3000 focus:ring-0" placeholder="{l s='Email address' d='Shop.Forms.Labels'}" value="{if isset($smarty.post.email)}{$smarty.post.email|stripslashes}{/if}" class="form-control" required>
          <button class="form-control-submit hidden tablet:flex w-full text-xs tablet:text-sm tablet:w-auto bg-main-dark hover:bg-main-hover duration-150 border-0 rounded-full text-white p-3 px-4 uppercase whitespace-nowrap mb-8 tablet:mb-0 items-center justify-between ml-auto cursor-pointer" name="submit" type="submit">
          ...
          <button class="form-control-submit tablet:hidden w-full text-xs tablet:text-sm tablet:w-auto bg-main-dark hover:bg-main-hover duration-150 border-0 rounded-full text-white p-3 px-4 uppercase whitespace-nowrap mb-8 tablet:mb-0 flex items-center justify-between ml-auto cursor-pointer" name="submit" type="submit">

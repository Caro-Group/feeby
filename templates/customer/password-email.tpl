    ...
    <section class="form-fields">
      <div class="form-group center-email-fields row">
        <div class="flex w-full items-center flex-wrap tablet:flex-nowrap">
          ...
          <button class=" hidden tablet:flex w-full text-xs tablet:text-sm tablet:w-auto bg-main hover:bg-main-hover duration-150 border-0 rounded-full text-white p-3 px-4 uppercase whitespace-nowrap mb-8 tablet:mb-0 items-center justify-between ml-auto cursor-pointer" name="submit" type="submit">
          ...
          <button class=" tablet:hidden w-full text-xs tablet:text-sm tablet:w-auto bg-main hover:bg-main-hover duration-150 border-0 rounded-full text-white p-3 px-4 uppercase whitespace-nowrap mb-8 tablet:mb-0 flex items-center justify-between ml-auto cursor-pointer" name="submit" type="submit">

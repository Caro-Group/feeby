  ...
  {if isset($category) && $category.image.large.url}
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 desktop-presta:mb-[10px]">
      <div class="-mx-[20px] tablet:mx-0">
        <picture>
          <source src="{$category.image.large.url}?timestamp={$category.date_upd|replace:'-':''|replace:' ':''|replace:':':''|replace:".png":".webp"|replace:".jpg":".webp"|escape:'html':'UTF-8'}" type="image/webp">
          <source src="{$category.image.large.url}?timestamp={$category.date_upd|replace:'-':''|replace:' ':''|replace:':':''|escape:'html':'UTF-8'}" type="image/jpeg"> 

      ...
      <section class="product-features">
        ...
        <dl class="block data-sheet">
          {foreach from=$product.grouped_features item=feature}
            <div class="flex">
              <dt class="name mb-[2px] p-2.5 tablet:p-5 bg-gray-1000 w-auto flex-[0_0_auto] w-[115px] tablet:w-[250px] text-main-dark font-medium text-sm tablet:text-base float-left">{$feature.name}</dt>

...
<div class="fixed z-[9999] inset-0 max-h-screen flex justify-center items-center p-5 bg-[#282828]/50 transition duration-300 pointer-events-none opacity-0" data-attr-popup>
    <div class="relative w-full max-w-[468px] tablet:max-w-[600px] bg-white rounded-[5px] py-7 transition duration-300 max-h-full flex flex-col">
        ...
        <div class="w-full px-7 overflow-y-auto [&_img]:w-full [&_img]:h-auto [&_p]:grid [&_p]:grid-cols-1 tablet:[&_p]:grid-cols-2 [&_p]:gap-5">

 ...
 *}
  ...
  {foreach from=$listing.sort_orders item=sort_order}
    ...
    >
    <span class="inline-block mr-3 top-1 w-5 h-5 rounded border-2 border-solid border-gray-3000 group-hover:border-main transition duration-200 relative  before:absolute before:content-[''] before:rounded-sm before:w-2.5 before:h-2.5 before:inset-0 before:m-auto "></span>

    ...
    <div id="search_sort_modal_inner" class="modal_productList-inner">
      ...
      <div id="sort-list" class="px-[30px] overflow-y-auto scrollbar-custom">
        {foreach from=$listing.sort_orders item=sort_order}
          ...
          >
          <span class="inline-block mr-3 top-1 w-5 h-5 rounded border-2 border-solid border-gray-3000 group-hover:border-main relative  before:absolute before:content-[''] before:rounded-sm before:w-2.5 before:h-2.5 before:left-[3.75px] before:top-[3.5px] before:transition before:duration-200 "></span>
            {$sort_order.label}
          </a>
        {/foreach}
      </div>

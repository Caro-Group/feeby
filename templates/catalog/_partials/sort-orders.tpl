...
<div class="products-sort-order w-full dropdown select-title text-base">
  <button
    class="select-title w-full text-base bg-transparent px-5 py-2 tablet:py-2.5 text-left !flex justify-between font-light text-main-dark border-gray-2000 hover:border-gray-3000 rounded-md border-solid !border-2 transition duration-200"
    rel="nofollow"
    ...
    aria-expanded="false">
     ...
     <span class="shrink-0 ml-2 tablet:hidden text-main-dark"><svg class="fill-current" width="18" height="12" viewBox="0 0 18 12" fill="none" xmlns="http://www.w3.org/2000/svg">

 ...
 *}
<div class="col-sm-12 col-xs-12 products-sort-order dropdown tablet:bg-gray-1000 px-0 py-2 tablet:py-2.5 rounded-md tablet:border-0 border-solid border-gray-1000 border-2 tablet:rounded-none tablet:rounded-r-md select-title text-base">
  <button

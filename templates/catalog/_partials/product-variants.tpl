...
<span style="display:flex;font-weight: bold;font-size: 20px;line-height: 27px;align-items: center;margin-bottom:10px;">
	{if $group.group_name == "Rozmiar"}
		<span style="margin-right:5px;">Wybierz rozmiar</span>

  ...
  {block name='product_cover_thumbnails'}
      {block name='product_cover'}
        ...
        {if $product.default_image}
          <img id="zoom_product" data-type-zoom="" class="js-qv-product-cover img-fluid" width="{$product.default_image.width}" height="{$product.default_image.height}" src="{$link->getImageLink($product->link_rewrite, $product.default_image.id_image)}"  alt="{$product.default_image.legend}" title="{$product.default_image.legend}" itemprop="image">

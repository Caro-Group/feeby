   ...
   {block name='product_cover'}
     {if $product.default_image}
       ...
       {/foreach}
         ...
         <div class="absolute bottom-2.5 tablet:bottom-5 inset-x-2.5 tablet:inset-x-5 z-50 flex justify-between tablet:justify-start tablet:gap-2.5 items-center z-10">

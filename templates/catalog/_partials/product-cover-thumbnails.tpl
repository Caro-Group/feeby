  ...
  {block name='product_cover_thumbnails'}
      {block name='product_cover'}
        ...
        {if $product.default_image}
          ...
          <img id="product_original_img" class="hidden" src="{$link->getImageLink($product->link_rewrite, $product.default_image.id_image)}"  alt="{$product.default_image.legend}" title="{$product.default_image.legend}" itemprop="image" data-pagespeed-no-transform>

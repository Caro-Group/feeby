  ...
  <div class="product-prices">
    ...
    <div class="flex flex-row items-baseline"> 
      ...
      {block name='product_price'}
        <div
          class="font-medium leading-none product-price text-[35px] mr-[10px] {if $product.has_discount}text-main{else}text-[#232322]{/if} {if $product.has_discount}has-discount{/if}"
          itemprop="offers"
          itemscope

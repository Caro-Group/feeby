			...
			{/block}
				...
				{block name='product_price_and_shipping'}
					{if $product.show_price}
						...
						<span itemprop="price" class=" {if $product.has_discount} text-main {else} text-main-dark {/if} text-base tablet:text-xl font-medium font-body">{$product.price} {$product.unity|escape:'html':'UTF-8'}</span>

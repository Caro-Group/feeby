                ...
                <div class="flex justify-between flex-col bg-gray-1000 rounded-[5px] flex-auto max-w-screen-tablet-wide relative mt-12 desktop-presta:mt-0 overflow-hidden">
                    <div class="w-full pt-5 px-5">
                        <span class="group inline-flex items-center w-8 h-8 desktop-presta:w-10 desktop-presta:h-10 text-gray-3000 hover:text-main">
                            ...
                            <div class="hidden group-hover:flex hover:flex justify-center items-center rounded-[5px] absolute bg-gray-1000/90 duration-200 h-full inset-0 opacity-0 group-hover:opacity-100 hover:opacity-100 hover:opacity-100 z-0 group-hover:z-40 hover:z-40 transition w-full py-[47px] ">
                                <div class="p-5 tablet-medium:p-12 overflow-y-auto">

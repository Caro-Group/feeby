...
<div data-product-configurable="modal" class="fixed inset-0 bg-main-dark bg-opacity-50 z-30 p-5 desktop-presta:p-12 overflow-y-auto"  aria-labelledby="modal-title" role="dialog" aria-modal="true">
        ...
        <div class="flex justify-between flex-col bg-gray-1000 rounded-[5px] flex-auto max-w-screen-tablet-wide relative mt-12 desktop-presta:mt-0 overflow-hidden">
            <div class="w-full pt-5 px-5">
                <span class="group flex items-center w-8 h-8 desktop-presta:w-10 desktop-presta:h-10 text-gray-3000 hover:text-main">
                    ...
                    <div class=" rounded-[5px] absolute bg-main duration-200 h-full inset-0 opacity-0 group-hover:opacity-20 z-0 group-hover:z-40 pointer-events-none transition w-full">
                    </div>
                </span>
            </div>

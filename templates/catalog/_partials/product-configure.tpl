      ...
      <div class="modal-body p-0">
        ...
        <div data-product-configurable="modal" class="transition fixed inset-0 bg-main-dark bg-opacity-50 z-30 p-0 desktop-presta:px-12  desktop-presta:py-5 overflow-y-auto"  aria-labelledby="modal-title" role="dialog" aria-modal="true">
            <div class="relative flex flex-col desktop-presta:flex-row bg-white h-full overflow-y-auto desktop-presta:overflow-auto w-full content-max:mx-auto content-max:max-w-screen-content-max desktop-presta:rounded-[5px] p-0 tablet:p-5 desktop-presta:p-[50px] min-h-[640px] full-hd:min-h-[860px] ">
                ...
                <h1 class="max-w-screen-tablet-wide mx-auto w-full desktop-presta:hidden mt-5 desktop-presta:mt-0 flex-shrink-0 font-body font-normal product-detail-name text-xl leading-24px mb-5 pr-[70px] pl-5 tablet:pl-0 tablet:pr-[46px]" itemprop="name">
                ...
                <div class="flex flex-col px-5 tablet:px-0 phone:mb-[100px] desktop-presta:mb-0 desktop-presta:flex-[0_0_320px] desktop-wide:flex-[0_0_610px] max-w-screen-tablet-wide mx-auto w-full desktop-presta:pl-5 desktop-wide:pl-[50px]">
                    <h1 class="hidden desktop-presta:block mt-5 desktop-presta:mt-0 flex-shrink-0 font-body font-normal product-detail-name text-[35px] leading-24px mb-5 pr-[46px]" itemprop="name">
                        {block name='page_title'}
                            {$product.name}
                        {/block}
                    </h1>

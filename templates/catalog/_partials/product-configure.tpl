<div class="fixed inset-0 bg-main-dark bg-opacity-50 z-30 p-5 desktop-presta:p-12">
    <div class="relative flex flex-col desktop-presta:flex-row bg-white h-full w-full content-max:mx-auto content-max:max-w-screen-content-max rounded-[5px] p-5 desktop-presta:p-[50px] ">
        ...
        <div class="flex justify-between flex-col bg-gray-1000 rounded-[5px] flex-auto max-w-screen-tablet-wide relative mt-4 desktop-presta:mt-0">
            <div class="w-full pt-5 px-5">
                <span class="flex peer items-center w-8 h-8 desktop-presta:w-10 desktop-presta:h-10 text-gray-3000 hover:text-main">
                    <svg class="fill-current" width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class=" absolute bg-main duration-300 h-full inset-0 opacity-0 group-hover:opacity-50 z-0 group-hover:z-40 pointer-events-none transition w-full">
                    </div>
                </span>
            </div>
            <div class=" flex justify-between items-center w-full pb-5 px-5">
                <div>
                    ...
                    <a href="#" class="focus:text-gray-3000 focus:hover:text-main flex-[0_0_auto] flex items-center text-sm text-gray-3000 hover:text-main transition font-body font-normal tablet:text-base">

    ...
    <div class="relative flex flex-col tablet-medium:flex-row bg-white h-full w-full content-max:mx-auto content-max:max-w-screen-content-max rounded-[5px] p-5 desktop-presta:p-[50px] ">
        ...
        <div class="flex justify-between flex-col bg-gray-1000 rounded-[5px] flex-auto max-w-screen-tablet-wide relative">
            <div class="w-full pt-5 px-5">
                <span class=" w-5 h-5 desktop-presta:w-10 desktop-presta:h-10">
            ...
            <div class=" flex justify-between items-end w-full pb-5 px-5">
                <div>
                    ...
                    <span class=" flex items-center text-sm text-gray-3000 hover:text-main transition font-body font-normal tablet:text-base">
                        {l s='Pobierz PDF' d='Shop.Theme.Catalog'}
                        <svg class="ml-2 fill-current transition" width="20" height="26" viewBox="0 0 20 26"  xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="flex flex-col tablet-medium:flex-[0_0_320px] desktop-wide:flex-[0_0_610px] pl-5 desktop-wide:pl-[50px] overflow-y-auto">
            ...
            <div class=" overflow-y-auto overfolw-x-hidden ">

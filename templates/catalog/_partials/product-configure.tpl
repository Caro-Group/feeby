                    ...
                    <div class="swiper-wrapper items-center">
                        ...
                        {for $part=1 to 5}
                            <div class="swiper-slide w-[100px] phablet:w-[150px] overflow-hidden " data-product-configurable="part-{$part}">
                                <img class=" select-none w-[500%] max-w-none tablet:max-h-[640px] tablet:object-cover object-cover {if $part> 1 } -translate-x-{$part - 1}/5 {/if}" src="{$imageOriginal}" alt="{$product.name} part {$part}">

    ...
    <div class="relative flex flex-col desktop-presta:flex-row bg-white h-full w-full content-max:mx-auto content-max:max-w-screen-content-max rounded-[5px] p-5 desktop-presta:p-[50px] ">
        ...
        <div class="flex justify-between flex-col bg-gray-1000 rounded-[5px] flex-auto max-w-screen-tablet-wide relative mt-4 desktop-presta:mt-0">
            <div class="w-full pt-5 px-5">
                <span class="flex peer items-center w-8 h-8 desktop-presta:w-10 desktop-presta:h-10">
                ...
                <div class=" opacity-0 peer-hover:opacity-1 transition duration-300">
                </div>
            </div>
            <div class=" flex justify-between items-center w-full pb-5 px-5">
                <div>
                    ...
                    <a class="focus:text-gray-3000 focus:hover:text-main flex-[0_0_auto] flex items-center text-sm text-gray-3000 hover:text-main transition font-body font-normal tablet:text-base">
        ...
        <div class="flex flex-col desktop-presta:flex-[0_0_320px] desktop-wide:flex-[0_0_610px] pl-5 desktop-wide:pl-[50px] overflow-y-auto">
            ...
            <div class=" overflow-y-auto overflow-x-hidden min-h-14 mr-2">

<div class="fixed inset-0 bg-main-dark bg-opacity-50 z-30 p-5 tablet-medium:p-12">
    <div class="relative flex flex-col tablet-medium:flex-row bg-white h-full w-full content-max:mx-auto content-max:max-w-screen-content-max rounded-[5px] p-5 desktop-presta:p-[50px] ">
        <span class=" absolute top-5 right-5 tablet-medium:top-[50px] tablet-medium:right-[50px] ">
            <i class=" material-icons text-main-dark hover:text-main text-4xl transition select-none"></i>
        </span>
        
        <div class="flex justify-between flex-col bg-gray-1000 rounded-[5px] flex-auto max-w-screen-tablet-wide relative">
            <div class="w-full pt-5 px-5">
                <span class=" w-5 h-5 tablet-medium:w-10 tablet-medium:h-10">
                    <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M25 3.125C12.9199 3.125 3.125 12.9199 3.125 25C3.125 37.0801 12.9199 46.875 25 46.875C37.0801 46.875 46.875 37.0801 46.875 25C46.875 12.9199 37.0801 3.125 25 3.125ZM25 43.1641C14.9707 43.1641 6.83594 35.0293 6.83594 25C6.83594 14.9707 14.9707 6.83594 25 6.83594C35.0293 6.83594 43.1641 14.9707 43.1641 25C43.1641 35.0293 35.0293 43.1641 25 43.1641Z" fill="#DF1A5B"/>
            ...
            <div class=" flex justify-between items-end w-full pb-5 px-5">
                <div>
                    <p class="text-xs text-gray-3000 font-body font-normal">
        ...
        <div class="flex flex-col tablet-medium:flex-[0_0_320px] desktop-wide:flex-[0_0_610px] pl-5 desktop-wide:pl-[50px] overflow-y-scroll">
            ...
            <div class=" flex-shrink-0 ">
                ...
                <div class="flex ">
                    <div class="add flex-1">
                        <button class="bg-main border-0 cursor-pointer font-medium h-full hover:bg-main-hover overflow-hidden phone-wide:text-base px-4 relative rounded-full tablet:text-xl text-base text-center text-white transition uppercase w-full" data-button-action="add-to-cart" type="submit">

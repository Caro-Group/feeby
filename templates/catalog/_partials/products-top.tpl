      ...
      <div
        ...
        <div class="flex relative">
          {if !empty($externalFilters) || (isset($listing.rendered_facets) && $listing.rendered_facets)}
            <span class="p-[13px] md:p-5 font-header text-gray-3000 text-xl tablet:text-3xl cursor-pointer transition duration-200" data-filters-tab='0' >{l s='Filter' d='Shop.Theme.Actions'}</span>
          {/if}
          <span class="p-[13px] md:p-5 font-header text-gray-3000 text-xl tablet:text-3xl cursor-pointer transition duration-200" data-filters-tab='1' >{l s='Sort by:' d='Shop.Theme.Global'}</span>

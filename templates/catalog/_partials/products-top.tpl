...
<div id="js-product-list-top" class="pb-1 tablet:pb-3 pt-0 products-selection tablet:mb-10 {if (isset($page.page_name) && $page.page_name == 'search')} tablet:pr-36 {/if}">
    ...
    <div style="flex:0 0 auto;" class="w-1/2 tablet:w-[232px] order-1 flex justify-center ">
      {if !empty($externalFilters) || (!empty($listing.rendered_facets))}
        ...
        data-filters-tab-btn='0'
          class="flex items-center justify-between cursor-pointer border-2 border-solid border-gray-2000 px-5 tablet:px-10 text-left text-sm tablet:text-base uppercase text-normal bg-gray-1000 hover:border-gray-3000 rounded-md text-main-dark text-left w-full transition duration-200" >
          {l s='Filter' d='Shop.Theme.Actions'}
          <span class="top-[3px] float-right pl-4 relative ">
            <svg class="tablet:w-5 tablet:h-5" width="18" height="18" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class=" w-full select-title text-base">
          <button
            ...
            <span class="shrink-0 ml-2 text-main-dark">
              <svg class="fill-current tablet:w-5 tablet:h-5 tablet:top-[3px] relative" width="18" height="12" viewBox="0 0 18 12" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div
        ...
        <div class="flex relative">
          {if !empty($externalFilters) || (isset($listing.rendered_facets) && $listing.rendered_facets)}
            <span class="p-[13px] md:p-5 font-header text-gray-3000 text-xl tablet:text-[25px] cursor-pointer transition duration-200" data-filters-tab='0' >{l s='Filter' d='Shop.Theme.Actions'}</span>
          {/if}
          <span class="p-[13px] md:p-5 font-header text-gray-3000 text-xl tablet:text-[25px] cursor-pointer transition duration-200" data-filters-tab='1' >{l s='Sort by:' d='Shop.Theme.Global'}</span>

...
<div id="js-product-list-top" class="products-selection">
  <div style="display: flex;flex-wrap: wrap;">
    ...
    <div style="flex: 1 1 auto;background: #000;display: flex;align-items: center;justify-content: center;color: #fff;border-radius: 20px;padding: 5px 35px 5px 15px;margin-bottom: 10px;" class="hidden-md-up" data-category-id="{$id_category}">

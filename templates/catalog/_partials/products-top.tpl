    ...
    <div style="flex:0 0 auto;" class="hidden-md-up w-1/2 pr-[10px] order-1 flex justify-center ">
      {if !empty($listing.rendered_facets)}
        ...
        <button id="search_filters_toggler"
          class="cursor-pointer border-2 border-solid border-gray-2000 px-5 text-left text-base text-normal bg-gray-1000 rounded-md text-main-dark text-left w-full" >
    ...
    {block name='product_list_active_filters'}
      {if isset($listing.rendered_facets) && $listing.rendered_facets}
        <div id="search_filters_modal"
          ...
          <div class="flex flex-col bg-white w-full h-full rounded-[5px]">

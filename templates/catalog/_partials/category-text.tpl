 ...
 *}
 ...
 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 tablet:mb-[15px] ">
    <div id="category_description" class="collapse min-h-10 pb-5 relative overflow-hidden after:absolute after:content-[''] after:bottom-0 after:inset-x-0 after:h-2 after:from-white after:to-transparent after:bg-gradient-to-t" aria-expanded="false">

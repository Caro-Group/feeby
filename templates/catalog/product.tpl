   ...
   {else}
     ...
     <section id="main" class="product-detail tablet:pt-[20px] desktop-presta:pt-0" itemscope itemtype="https://schema.org/Product">
       ...
       <div class="flex flex-wrap flex-row mb-16 tablet:mb-0">
         <div class="w-full tablet:w-3/5 1920:w-[calc(66.666667%_-_30px)] tablet:pr-[55px] 1920:pr-[25px] tablet:pb-10">
            ...
            {if $product.is_customizable && count($product.customizations.fields)}
             ...
             <div class="flex flex-wrap mt-5 leading-normal text-sm gap-2.5 tablet:gap-5 w-full">
              ...
              {if $language.iso_code == 'pl'}
                {if $breadcrumb["count"] > 0 && $breadcrumb["links"][1]["title"]|strstr:"Parawany"}/nasze-parawany{else}/technologia-wykonania{/if}
              {else}
                {if $breadcrumb["count"] > 0 && $breadcrumb["links"][1]["title"]|strstr:"Room Dividers"}/our-room-dividers{else}/manufacturing-technology{/if}
              {/if}" target="_blank" class="flex items-center tablet-medium:basis-auto transition">

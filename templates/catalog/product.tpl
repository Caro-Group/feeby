         ...
         <div class="h-max relative tablet:w-2/5 top-0 w-full tablet:sticky">
           ...
           <div class="product-information">
            ...
            {if $product.is_customizable && count($product.customizations.fields)}
             ...
             <div class="flex flex-wrap mt-5 leading-normal text-sm tablet:text-base gap-2.5 tablet:gap-5 w-full">
              <a href="{if $breadcrumb["count"] > 0 && $breadcrumb["links"][1]["title"]|strstr:"Parawany"}/nasze-parawany{else}/technologia-wykonania{/if}" target="_blank" class="flex items-center phone-wide:basis-[calc(50%_-_5px)] tablet-medium:basis-auto transition">

        ...
        <div class="h-max position-sticky tablet:w-2/5 top-0 w-full">
          ...
          <div class="product-information">
            ...
            {if isset($category) && $category->id_parent == 582} {* CATEGORY: ARTIST *}
              ...
              <a href="{$link->getCategoryLink($category->id)}" class="flex flex-row flex-wrap border-2 border-solid border-gray-default p-[10px] rounded-[5px] max-w-[240px] mb-[40px] hover:border-main group">
                ...
                <svg class="ml-auto my-auto mr-3 group-hover:ml-1" xmlns="http://www.w3.org/2000/svg" width="7" height="14" fill="none"><path d="M7 6.175.868 0H.867L0 .873l5.782 5.739-5.78 5.737.866.873L7 7.048v-.873Z" fill="#232322"/></svg>
              </a>
            {/if}
